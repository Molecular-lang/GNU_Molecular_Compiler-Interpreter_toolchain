...
static tree
process_init_constructor (tree type, tree init, int nested, int flags, tsubst_flags_t complain);
...
{
  tree binfo = lookup_base (type, base, ba_unique, NULL, tf_warning_or_error);
