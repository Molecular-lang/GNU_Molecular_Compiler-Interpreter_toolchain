...
#define BINDING_VECTOR_ALLOC_CLUSTERS(NODE) (BINDING_VECTOR_CHECK (NODE)->base.u.dependence_info.clique)
#define BINDING_VECTOR_NUM_CLUSTERS(NODE) (BINDING_VECTOR_CHECK (NODE)->base.u.dependence_info.base)
#define BINDING_VECTOR_CLUSTER_BASE(NODE) (((tree_binding_vec *)BINDING_VECTOR_CHECK (NODE))->vec)
#define BINDING_VECTOR_CLUSTER_LAST(NODE) (&BINDING_VECTOR_CLUSTER (NODE, BINDING_VECTOR_NUM_CLUSTERS (NODE) - 1))
#define BINDING_VECTOR_CLUSTER(NODE,IX) (((tree_binding_vec *)BINDING_VECTOR_CHECK (NODE))->vec[IX])
...
#define BINDING_VECTOR_NAME(NODE) (((tree_binding_vec *)BINDING_VECTOR_CHECK (NODE))->name)
...
/* This binding contains duplicate references to a global module entity.  */
#define BINDING_VECTOR_GLOBAL_DUPS_P(NODE) (BINDING_VECTOR_CHECK (NODE)->base.static_flag)
/* This binding contains duplicate references to a partioned module entity.  */
#define BINDING_VECTOR_PARTITION_DUPS_P(NODE) (BINDING_VECTOR_CHECK (NODE)->base.volatile_flag)
...
#define MODULE_BINDING_GLOBAL_P(NODE) (OVERLOAD_CHECK (NODE)->base.static_flag)
/* This slot is part of the current module (a partition or primary).  */
#define MODULE_BINDING_PARTITION_P(NODE) (OVERLOAD_CHECK (NODE)->base.volatile_flag)
...
extern bool is_nested_namespace(tree parent, tree descendant, bool inline_only = false);
