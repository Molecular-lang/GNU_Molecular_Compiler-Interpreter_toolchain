...
#define OPTION_MASK_ISA_3DNOW_SET (OPTION_MASK_ISA_3DNOW | OPTION_MASK_ISA_MMX_SET)
#define OPTION_MASK_ISA_3DNOW_A_SET (OPTION_MASK_ISA_3DNOW_A | OPTION_MASK_ISA_3DNOW_SET)

#define OPTION_MASK_ISA_SSE_SET OPTION_MASK_ISA_SSE
#define OPTION_MASK_ISA_SSE2_SET (OPTION_MASK_ISA_SSE2 | OPTION_MASK_ISA_SSE_SET)
#define OPTION_MASK_ISA_SSE3_SET (OPTION_MASK_ISA_SSE3 | OPTION_MASK_ISA_SSE2_SET)
#define OPTION_MASK_ISA_SSSE3_SET (OPTION_MASK_ISA_SSSE3 | OPTION_MASK_ISA_SSE3_SET)
#define OPTION_MASK_ISA_SSE4_1_SET (OPTION_MASK_ISA_SSE4_1 | OPTION_MASK_ISA_SSSE3_SET)
#define OPTION_MASK_ISA_SSE4_2_SET (OPTION_MASK_ISA_SSE4_2 | OPTION_MASK_ISA_SSE4_1_SET)
#define OPTION_MASK_ISA_AVX_SET \
	(OPTION_MASK_ISA_AVX | OPTION_MASK_ISA_SSE4_2_SET | OPTION_MASK_ISA_XSAVE_SET)
#define OPTION_MASK_ISA_FMA_SET (OPTION_MASK_ISA_FMA | OPTION_MASK_ISA_AVX_SET)
#define OPTION_MASK_ISA_AVX2_SET (OPTION_MASK_ISA_AVX2 | OPTION_MASK_ISA_AVX_SET)
#define OPTION_MASK_ISA_FXSR_SET OPTION_MASK_ISA_FXSR
#define OPTION_MASK_ISA_XSAVE_SET OPTION_MASK_ISA_XSAVE
#define OPTION_MASK_ISA_XSAVEOPT_SET (OPTION_MASK_ISA_XSAVEOPT | OPTION_MASK_ISA_XSAVE_SET)
#define OPTION_MASK_ISA_AVX512F_SET (OPTION_MASK_ISA_AVX512F | OPTION_MASK_ISA_AVX2_SET)
#define OPTION_MASK_ISA_AVX512CD_SET (OPTION_MASK_ISA_AVX512CD | OPTION_MASK_ISA_AVX512F_SET)
#define OPTION_MASK_ISA_AVX512PF_SET (OPTION_MASK_ISA_AVX512PF | OPTION_MASK_ISA_AVX512F_SET)
#define OPTION_MASK_ISA_AVX512ER_SET (OPTION_MASK_ISA_AVX512ER | OPTION_MASK_ISA_AVX512F_SET)
#define OPTION_MASK_ISA_AVX512DQ_SET (OPTION_MASK_ISA_AVX512DQ | OPTION_MASK_ISA_AVX512F_SET)
#define OPTION_MASK_ISA_AVX512BW_SET (OPTION_MASK_ISA_AVX512BW | OPTION_MASK_ISA_AVX512F_SET)
#define OPTION_MASK_ISA_AVX512VL_SET (OPTION_MASK_ISA_AVX512VL | OPTION_MASK_ISA_AVX512F_SET)
#define OPTION_MASK_ISA_AVX512IFMA_SET (OPTION_MASK_ISA_AVX512IFMA | OPTION_MASK_ISA_AVX512F_SET)
#define OPTION_MASK_ISA_AVX512VBMI_SET (OPTION_MASK_ISA_AVX512VBMI | OPTION_MASK_ISA_AVX512BW_SET)
...
#define OPTION_MASK_ISA_AVX512VBMI2_SET (OPTION_MASK_ISA_AVX512VBMI2 | OPTION_MASK_ISA_AVX512F_SET)
...
#define OPTION_MASK_ISA_AVX512VNNI_SET (OPTION_MASK_ISA_AVX512VNNI | OPTION_MASK_ISA_AVX512F_SET)
#define OPTION_MASK_ISA2_AVXVNNI_SET OPTION_MASK_ISA2_AVXVNNI
#define OPTION_MASK_ISA_AVX512VPOPCNTDQ_SET (OPTION_MASK_ISA_AVX512VPOPCNTDQ | OPTION_MASK_ISA_AVX512F_SET)
#define OPTION_MASK_ISA_AVX512BITALG_SET (OPTION_MASK_ISA_AVX512BITALG | OPTION_MASK_ISA_AVX512F_SET)
...
#define OPTION_MASK_ISA_XSAVES_SET (OPTION_MASK_ISA_XSAVES | OPTION_MASK_ISA_XSAVE_SET)
#define OPTION_MASK_ISA_XSAVEC_SET (OPTION_MASK_ISA_XSAVEC | OPTION_MASK_ISA_XSAVE_SET)
...
#define OPTION_MASK_ISA_SSE4A_SET (OPTION_MASK_ISA_SSE4A | OPTION_MASK_ISA_SSE3_SET)
#define OPTION_MASK_ISA_FMA4_SET (OPTION_MASK_ISA_FMA4 | OPTION_MASK_ISA_SSE4A_SET | OPTION_MASK_ISA_AVX_SET)
#define OPTION_MASK_ISA_XOP_SET (OPTION_MASK_ISA_XOP | OPTION_MASK_ISA_FMA4_SET)
#define OPTION_MASK_ISA_LWP_SET OPTION_MASK_ISA_LWP

/* AES, SHA and PCLMUL need SSE2 because they use xmm registers.  */
#define OPTION_MASK_ISA_AES_SET (OPTION_MASK_ISA_AES | OPTION_MASK_ISA_SSE2_SET)
#define OPTION_MASK_ISA_SHA_SET (OPTION_MASK_ISA_SHA | OPTION_MASK_ISA_SSE2_SET)
#define OPTION_MASK_ISA_PCLMUL_SET (OPTION_MASK_ISA_PCLMUL | OPTION_MASK_ISA_SSE2_SET)

#define OPTION_MASK_ISA_ABM_SET (OPTION_MASK_ISA_ABM | OPTION_MASK_ISA_POPCNT)
...
#define OPTION_MASK_ISA_F16C_SET (OPTION_MASK_ISA_F16C | OPTION_MASK_ISA_AVX_SET)
...
#define OPTION_MASK_ISA2_WIDEKL_SET (OPTION_MASK_ISA2_WIDEKL | OPTION_MASK_ISA2_KL_SET)

/* Define a set of ISAs which aren't available when a given ISA is
   disabled.  MMX and SSE ISAs are handled separately.  */

#define OPTION_MASK_ISA_MMX_UNSET (OPTION_MASK_ISA_MMX | OPTION_MASK_ISA_3DNOW_UNSET)
#define OPTION_MASK_ISA_3DNOW_UNSET (OPTION_MASK_ISA_3DNOW | OPTION_MASK_ISA_3DNOW_A_UNSET)
...
#define OPTION_MASK_ISA_SSE2_UNSET (OPTION_MASK_ISA_SSE2 | OPTION_MASK_ISA_SSE3_UNSET)
#define OPTION_MASK_ISA_SSE3_UNSET (OPTION_MASK_ISA_SSE3 | OPTION_MASK_ISA_SSSE3_UNSET | OPTION_MASK_ISA_SSE4A_UNSET )
#define OPTION_MASK_ISA_SSSE3_UNSET (OPTION_MASK_ISA_SSSE3 | OPTION_MASK_ISA_SSE4_1_UNSET)
#define OPTION_MASK_ISA_SSE4_1_UNSET (OPTION_MASK_ISA_SSE4_1 | OPTION_MASK_ISA_SSE4_2_UNSET)
#define OPTION_MASK_ISA_SSE4_2_UNSET (OPTION_MASK_ISA_SSE4_2 | OPTION_MASK_ISA_AVX_UNSET )
#define OPTION_MASK_ISA_AVX_UNSET (OPTION_MASK_ISA_AVX | OPTION_MASK_ISA_FMA_UNSET \
   | OPTION_MASK_ISA_FMA4_UNSET | OPTION_MASK_ISA_F16C_UNSET | OPTION_MASK_ISA_AVX2_UNSET )
#define OPTION_MASK_ISA_FMA_UNSET OPTION_MASK_ISA_FMA
#define OPTION_MASK_ISA_FXSR_UNSET OPTION_MASK_ISA_FXSR
#define OPTION_MASK_ISA_XSAVE_UNSET (OPTION_MASK_ISA_XSAVE | OPTION_MASK_ISA_XSAVEOPT_UNSET \
   | OPTION_MASK_ISA_XSAVES_UNSET | OPTION_MASK_ISA_XSAVEC_UNSET | OPTION_MASK_ISA_AVX_UNSET)
#define OPTION_MASK_ISA2_XSAVE_UNSET (OPTION_MASK_ISA2_AVX2_UNSET | OPTION_MASK_ISA2_AMX_TILE_UNSET)
#define OPTION_MASK_ISA_XSAVEOPT_UNSET OPTION_MASK_ISA_XSAVEOPT
#define OPTION_MASK_ISA_AVX2_UNSET (OPTION_MASK_ISA_AVX2 | OPTION_MASK_ISA_AVX512F_UNSET)
#define OPTION_MASK_ISA2_AVX2_UNSET (OPTION_MASK_ISA2_AVXVNNI_UNSET | OPTION_MASK_ISA2_AVX512F_UNSET)
#define OPTION_MASK_ISA_AVX512F_UNSET (OPTION_MASK_ISA_AVX512F | OPTION_MASK_ISA_AVX512CD_UNSET \
...
#define OPTION_MASK_ISA_AVX512BW_UNSET (OPTION_MASK_ISA_AVX512BW | OPTION_MASK_ISA_AVX512VBMI_UNSET)
...
#define OPTION_MASK_ISA2_KL_UNSET (OPTION_MASK_ISA2_KL | OPTION_MASK_ISA2_WIDEKL_UNSET)
...
#define OPTION_MASK_ISA_SSE4A_UNSET (OPTION_MASK_ISA_SSE4A | OPTION_MASK_ISA_FMA4_UNSET)

#define OPTION_MASK_ISA_FMA4_UNSET (OPTION_MASK_ISA_FMA4 | OPTION_MASK_ISA_XOP_UNSET)
...
#define OPTION_MASK_ISA_GENERAL_REGS_ONLY_UNSET (OPTION_MASK_ISA_MMX_UNSET | OPTION_MASK_ISA_SSE_UNSET)

#define OPTION_MASK_ISA2_AVX512F_UNSET (OPTION_MASK_ISA2_AVX512BF16_UNSET \
...
#define OPTION_MASK_ISA2_GENERAL_REGS_ONLY_UNSET OPTION_MASK_ISA2_SSE_UNSET
...
#define OPTION_MASK_ISA2_SSE2_UNSET (OPTION_MASK_ISA2_SSE3_UNSET | OPTION_MASK_ISA2_KL_UNSET)
#define OPTION_MASK_ISA2_SSE_UNSET OPTION_MASK_ISA2_SSE2_UNSET

#define OPTION_MASK_ISA2_AVX512BW_UNSET (OPTION_MASK_ISA2_AVX512BF16_UNSET | OPTION_MASK_ISA2_AVX512FP16_UNSET)
	...
	switch(code) {
		case OPT_mgeneral_regs_only:
			if (value) {
				...
				/* Disable MMX, SSE and x87 instructions if only general registers are allowed.  */
				opts->x_ix86_isa_flags &= ~OPTION_MASK_ISA_GENERAL_REGS_ONLY_UNSET;
				opts->x_ix86_isa_flags2 &= ~OPTION_MASK_ISA2_GENERAL_REGS_ONLY_UNSET;
				opts->x_ix86_isa_flags |= general_regs_only_flags;
				opts->x_ix86_isa_flags2 |= general_regs_only_flags2;
				opts->x_ix86_isa_flags_explicit |= (OPTION_MASK_ISA_GENERAL_REGS_ONLY_UNSET | general_regs_only_flags);
				opts->x_ix86_isa_flags2_explicit |= (OPTION_MASK_ISA2_GENERAL_REGS_ONLY_UNSET | general_regs_only_flags2);
		...
		case OPT_mavx512vpopcntdq:
			if (value) {
				...
				opts->x_ix86_isa_flags_explicit |= OPTION_MASK_ISA_AVX512VPOPCNTDQ_SET;
			} else {
				opts->x_ix86_isa_flags &= ~OPTION_MASK_ISA_AVX512VPOPCNTDQ_UNSET;
				opts->x_ix86_isa_flags_explicit |= OPTION_MASK_ISA_AVX512VPOPCNTDQ_UNSET;
			}
			return true;
		...
		case OPT_mavx512bitalg:
			if (value) {
				...
				opts->x_ix86_isa_flags_explicit |= OPTION_MASK_ISA_AVX512BITALG_UNSET;
			}
			return true;
		...
		case OPT_malign_loops_:
			...
			if (value > MAX_CODE_ALIGN)
				error_at(loc, "%<-malign-loops=%d%> is not between 0 and %d", value, MAX_CODE_ALIGN);
			else
		...
		case OPT_malign_jumps_:
			...
			if (value > MAX_CODE_ALIGN)
				error_at(loc, "%<-malign-jumps=%d%> is not between 0 and %d", value, MAX_CODE_ALIGN);
			else
				set_malign_value(&opts->x_str_align_jumps, value);
			return true;

		case OPT_malign_functions_:
			warning_at(loc, 0, "%<-malign-functions%> is obsolete, use %<-falign-functions%>");
			if (value > MAX_CODE_ALIGN)
				error_at(loc, "%<-malign-functions=%d%> is not between 0 and %d", value, MAX_CODE_ALIGN);
			else
...
static bool
ix86_supports_split_stack(bool report, struct gcc_options *opts ATTRIBUTE_UNUSED)
{
	...
	if (!HAVE_GAS_CFI_PERSONALITY_DIRECTIVE) {
		if (report)
			error("%<-fsplit-stack%> requires assembler support for CFI directives");
		ret = false;
	}
#endif
...
const pta processor_alias_table[] =
{
  ...
  {"generic", PROCESSOR_GENERIC, CPU_GENERIC, PTA_64BIT
      | PTA_HLE /* flags are only used for -march switch.  */, 0, P_NONE},

	{"amd", PROCESSOR_GENERIC, CPU_GENERIC, 0, M_VENDOR(VENDOR_AMD), P_NONE},
	{"amdfam10h", PROCESSOR_GENERIC, CPU_GENERIC, 0, M_CPU_TYPE(AMDFAM10H), P_NONE},
	{"amdfam15h", PROCESSOR_GENERIC, CPU_GENERIC, 0, M_CPU_TYPE(AMDFAM15H), P_NONE},
	{"amdfam17h", PROCESSOR_GENERIC, CPU_GENERIC, 0, M_CPU_TYPE(AMDFAM17H), P_NONE},
	{"amdfam19h", PROCESSOR_GENERIC, CPU_GENERIC, 0, M_CPU_TYPE(AMDFAM19H), P_NONE},
	{"shanghai", PROCESSOR_GENERIC, CPU_GENERIC, 0, M_CPU_TYPE(AMDFAM10H_SHANGHAI), P_NONE},
	{"istanbul", PROCESSOR_GENERIC, CPU_GENERIC, 0, M_CPU_TYPE(AMDFAM10H_ISTANBUL), P_NONE},
};
...
vec<const char *>
ix86_get_valid_option_values(int option_code, const char *prefix ATTRIBUTE_UNUSED)
{
	vec<const char *> v;
	v.create(0);
