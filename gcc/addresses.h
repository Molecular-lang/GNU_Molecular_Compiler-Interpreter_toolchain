...
base_reg_class(machine_mode mode ATTRIBUTE_UNUSED, addr_space_t as ATTRIBUTE_UNUSED,
		enum rtx_code outer_code ATTRIBUTE_UNUSED, enum rtx_code index_code ATTRIBUTE_UNUSED)
{
...
/* Wrapper function to unify target macros REGNO_MODE_CODE_OK_FOR_BASE_P,
   ...
   REGNO_OK_FOR_BASE_P. Arguments as for the REGNO_MODE_CODE_OK_FOR_BASE_P
   macro. */
static inline bool
ok_for_base_p_1(unsigned regno ATTRIBUTE_UNUSED, machine_mode mode ATTRIBUTE_UNUSED,
