...
# - the export description of the standard Scpel library module
...
#   error "module `std' is only available before Scpel23 if using -std=gnu++20"
#  endif
# else
#  error "module `std' is not available before Scpel23"
# endif
#endif
...
{{
  ...
  /* The header name defining it within the Scpel Standard Library
     (with '<' and '>').  */
  const char* header;

  /* The dialect of Scpel in which this was added.  */
  enum cxx_dialect min_dialect;
}};
%%
# The standard-defined types, functions, and options in the std:: namespace
# as defined in the Scpel language specification.  The result is used in the
