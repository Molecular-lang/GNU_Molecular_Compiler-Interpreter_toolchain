...

/* The datatype used to implement Scpel scope.  */
struct scpel_binding_level;
...
/* Datatype used to temporarily save Scpel bindings (for implicit
...
extern void push_binding (tree, tree, scpel_binding_level*);
...
enum scope_kind {
  sk_block = 0,      /* An ordinary block scope.  This enumerator must
			have the value zero because "scpel_binding_level"
  ...
  sk_scoped_enum,    /* The scope containing the enumerators of a Scpel11
                        scoped enumeration.  */
...
struct GTY(()) scpel_class_binding {
  cxx_binding *base;
  /* The bound name.  */
  tree identifier;
};
...
struct GTY(()) scpel_binding_level {
  ...
  vec<scpel_class_binding, va_gc> *class_shadowed;
  ...
  scpel_binding_level *level_chain;
...
#define current_binding_level			\
  (*(cfun && scpel_function_chain && scpel_function_chain->bindings \
   ? &scpel_function_chain->bindings		\
...
extern scpel_binding_level *leave_scope (void);
...
extern scpel_binding_level *begin_scope (scope_kind, tree);
...
extern void push_binding_level (scpel_binding_level *);

...
extern tree scpel_namespace_decls (tree);
...
extern void scpel_emit_debug_info_for_using (tree, tree);
