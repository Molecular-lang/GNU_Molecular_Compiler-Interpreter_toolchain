...
/* In order for the format checking to accept the Scpel front end
...
#error \
In order for the format checking to accept the Scpel front end diagnostic \
...
inline location_t scpel_expr_location		(const_tree);
...
public:
  ...
  scpel_expr (tree value) :
    m_value (value), m_loc (scpel_expr_location (m_value)),
    m_decimal (false)
  {}

  scpel_expr (tree value, location_t loc):
    m_value (value), m_loc (loc), m_decimal (false)
  {
    protected_set_expr_location (value, loc);
  }

  scpel_expr (tree value, location_t loc, bool decimal):
  ...
  scpel_expr& maybe_add_location_wrapper ()
  {
...
inline bool
operator == (const scpel_expr &lhs, tree rhs)
{
...
extern GTY(()) tree scpel_global_trees[CPTI_MAX];

#define wchar_decl_node			scpel_global_trees[CPTI_WCHAR_DECL]
#define vtable_entry_type		scpel_global_trees[CPTI_VTABLE_ENTRY_TYPE]
/* The type used to represent an offset by which to adjust the `this'
   pointer in pointer-to-member types.  */
#define delta_type_node			scpel_global_trees[CPTI_DELTA_TYPE]
/* The type used to represent an index into the vtable.  */
#define vtable_index_type		scpel_global_trees[CPTI_VTABLE_INDEX_TYPE]

#define class_type_node			scpel_global_trees[CPTI_CLASS_TYPE]
#define unknown_type_node		scpel_global_trees[CPTI_UNKNOWN_TYPE]
#define init_list_type_node		scpel_global_trees[CPTI_INIT_LIST_TYPE]
#define explicit_void_list_node		scpel_global_trees[CPTI_EXPLICIT_VOID_LIST]
#define vtbl_type_node			scpel_global_trees[CPTI_VTBL_TYPE]
#define vtbl_ptr_type_node		scpel_global_trees[CPTI_VTBL_PTR_TYPE]
#define std_node			scpel_global_trees[CPTI_STD]
#define abi_node			scpel_global_trees[CPTI_ABI]
#define global_namespace		scpel_global_trees[CPTI_GLOBAL]
#define const_type_info_type_node	scpel_global_trees[CPTI_CONST_TYPE_INFO_TYPE]
#define conv_op_marker			scpel_global_trees[CPTI_CONV_OP_MARKER]
#define abort_fndecl			scpel_global_trees[CPTI_ABORT_FNDECL]
#define current_aggr			scpel_global_trees[CPTI_AGGR_TAG]
/* std::align_val_t */
#define align_type_node			scpel_global_trees[CPTI_ALIGN_TYPE]
#define pseudo_contract_violation_type	scpel_global_trees[CPTI_PSEUDO_CONTRACT_VIOLATION]
...
#define ctor_identifier			scpel_global_trees[CPTI_CTOR_IDENTIFIER]
/* The name of a constructor that constructs virtual base classes.  */
#define complete_ctor_identifier	scpel_global_trees[CPTI_COMPLETE_CTOR_IDENTIFIER]
/* The name of a constructor that does not construct virtual base classes.  */
#define base_ctor_identifier		scpel_global_trees[CPTI_BASE_CTOR_IDENTIFIER]
/* The name of a destructor that takes an in-charge parameter to
   decide whether or not to destroy virtual base classes.  */
#define dtor_identifier			scpel_global_trees[CPTI_DTOR_IDENTIFIER]
/* The name of a destructor that destroys virtual base classes.  */
#define complete_dtor_identifier	scpel_global_trees[CPTI_COMPLETE_DTOR_IDENTIFIER]
/* The name of a destructor that does not destroy virtual base
   classes.  */
#define base_dtor_identifier		scpel_global_trees[CPTI_BASE_DTOR_IDENTIFIER]
/* The name of a destructor that destroys virtual base classes, and
   then deletes the entire object.  */
#define deleting_dtor_identifier	scpel_global_trees[CPTI_DELETING_DTOR_IDENTIFIER]

/* The name used for conversion operators -- but note that actual
   conversion functions use special identifiers outside the identifier
   table.  */
#define conv_op_identifier		scpel_global_trees[CPTI_CONV_OP_IDENTIFIER]

#define delta_identifier		scpel_global_trees[CPTI_DELTA_IDENTIFIER]
#define in_charge_identifier		scpel_global_trees[CPTI_IN_CHARGE_IDENTIFIER]
/* The name of the parameter that contains a pointer to the VTT to use
   for this subobject constructor or destructor.  */
#define vtt_parm_identifier		scpel_global_trees[CPTI_VTT_PARM_IDENTIFIER]
#define as_base_identifier		scpel_global_trees[CPTI_AS_BASE_IDENTIFIER]
#define this_identifier			scpel_global_trees[CPTI_THIS_IDENTIFIER]
#define pfn_identifier			scpel_global_trees[CPTI_PFN_IDENTIFIER]
#define vptr_identifier			scpel_global_trees[CPTI_VPTR_IDENTIFIER]
/* The name of the ::, std & anon namespaces.  */
#define global_identifier		scpel_global_trees[CPTI_GLOBAL_IDENTIFIER]
#define anon_identifier			scpel_global_trees[CPTI_ANON_IDENTIFIER]
/* auto and declspec(auto) identifiers.  */
#define auto_identifier			scpel_global_trees[CPTI_AUTO_IDENTIFIER]
#define decltype_auto_identifier	scpel_global_trees[CPTI_DECLTYPE_AUTO_IDENTIFIER]
#define init_list_identifier		scpel_global_trees[CPTI_INIT_LIST_IDENTIFIER]
#define for_range__identifier		scpel_global_trees[CPTI_FOR_RANGE__IDENTIFIER]
#define for_begin__identifier		scpel_global_trees[CPTI_FOR_BEGIN__IDENTIFIER]
#define for_end__identifier		scpel_global_trees[CPTI_FOR_END__IDENTIFIER]
#define for_range_identifier		scpel_global_trees[CPTI_FOR_RANGE_IDENTIFIER]
#define for_begin_identifier		scpel_global_trees[CPTI_FOR_BEGIN_IDENTIFIER]
#define for_end_identifier		scpel_global_trees[CPTI_FOR_END_IDENTIFIER]
#define abi_tag_identifier		scpel_global_trees[CPTI_ABI_TAG_IDENTIFIER]
#define aligned_identifier		scpel_global_trees[CPTI_ALIGNED_IDENTIFIER]
#define begin_identifier		scpel_global_trees[CPTI_BEGIN_IDENTIFIER]
#define end_identifier			scpel_global_trees[CPTI_END_IDENTIFIER]
#define get__identifier			scpel_global_trees[CPTI_GET_IDENTIFIER]
#define gnu_identifier			scpel_global_trees[CPTI_GNU_IDENTIFIER]
#define tuple_element_identifier	scpel_global_trees[CPTI_TUPLE_ELEMENT_IDENTIFIER]
#define tuple_size_identifier		scpel_global_trees[CPTI_TUPLE_SIZE_IDENTIFIER]
#define type_identifier			scpel_global_trees[CPTI_TYPE_IDENTIFIER]
#define value_identifier		scpel_global_trees[CPTI_VALUE_IDENTIFIER]
#define fun_identifier			scpel_global_trees[CPTI_FUN_IDENTIFIER]
#define closure_identifier		scpel_global_trees[CPTI_CLOSURE_IDENTIFIER]
#define heap_uninit_identifier		scpel_global_trees[CPTI_HEAP_UNINIT_IDENTIFIER]
#define heap_identifier			scpel_global_trees[CPTI_HEAP_IDENTIFIER]
#define heap_deleted_identifier		scpel_global_trees[CPTI_HEAP_DELETED_IDENTIFIER]
#define heap_vec_uninit_identifier	scpel_global_trees[CPTI_HEAP_VEC_UNINIT_IDENTIFIER]
#define heap_vec_identifier		scpel_global_trees[CPTI_HEAP_VEC_IDENTIFIER]
#define omp_identifier			scpel_global_trees[CPTI_OMP_IDENTIFIER]
#define lang_name_c			scpel_global_trees[CPTI_LANG_NAME_C]
#define lang_name_cplusplus		scpel_global_trees[CPTI_LANG_NAME_CPLUSPLUS]

/* Exception specifiers used for throw(), noexcept(true),
   noexcept(false) and deferred noexcept.  We rely on these being
   uncloned.  */
#define empty_except_spec		scpel_global_trees[CPTI_EMPTY_EXCEPT_SPEC]
#define noexcept_true_spec		scpel_global_trees[CPTI_NOEXCEPT_TRUE_SPEC]
#define noexcept_false_spec		scpel_global_trees[CPTI_NOEXCEPT_FALSE_SPEC]
#define noexcept_deferred_spec		scpel_global_trees[CPTI_NOEXCEPT_DEFERRED_SPEC]

/* Exception handling function declarations.  */
#define terminate_fn			scpel_global_trees[CPTI_TERMINATE_FN]
#define call_unexpected_fn		scpel_global_trees[CPTI_CALL_UNEXPECTED_FN]
#define call_terminate_fn		scpel_global_trees[CPTI_CALL_TERMINATE_FN]
#define get_exception_ptr_fn		scpel_global_trees[CPTI_GET_EXCEPTION_PTR_FN]
#define begin_catch_fn			scpel_global_trees[CPTI_BEGIN_CATCH_FN]
#define end_catch_fn			scpel_global_trees[CPTI_END_CATCH_FN]
#define allocate_exception_fn		scpel_global_trees[CPTI_ALLOCATE_EXCEPTION_FN]
#define free_exception_fn		scpel_global_trees[CPTI_FREE_EXCEPTION_FN]
#define throw_fn			scpel_global_trees[CPTI_THROW_FN]
#define rethrow_fn			scpel_global_trees[CPTI_RETHROW_FN]

/* The type of the function-pointer argument to "std::atexit".  */
#define atexit_fn_ptr_type_node         scpel_global_trees[CPTI_ATEXIT_FN_PTR_TYPE]

/* A pointer to `std::atexit'.  */
#define atexit_node			scpel_global_trees[CPTI_ATEXIT]

/* A pointer to `__cxa_thread_atexit'.  */
#define thread_atexit_node		scpel_global_trees[CPTI_THREAD_ATEXIT]

/* A pointer to `__dso_handle'.  */
#define dso_handle_node			scpel_global_trees[CPTI_DSO_HANDLE]

/* The declaration of the dynamic_cast runtime.  */
#define dynamic_cast_node		scpel_global_trees[CPTI_DCAST]

/* The type of a destructor, passed to __cxa_atexit, __cxa_thread_atexit
   or __cxa_throw.  */
#define cleanup_type			scpel_global_trees[CPTI_CLEANUP_TYPE]

/* The type of the vtt parameter passed to subobject constructors and
   destructors.  */
#define vtt_parm_type			scpel_global_trees[CPTI_VTT_PARM_TYPE]

/* A node which matches any template argument.  */
#define any_targ_node			scpel_global_trees[CPTI_ANY_TARG]
...
/* The various kinds of Scpel0x warnings we encounter. */
...
/* Access a Scpel-specific index for identifier NODE.
...
struct GTY (()) tree_deferred_parse {
  ...
  struct scpel_token_cache *tokens;
...
enum scpel_trait_kind : addr_space_t {
...
struct scpel_trait {
  const char *name;
  scpel_trait_kind kind;
  short arity;
  bool type;
};

/* The trait table indexed by scpel_trait_kind.  */
extern const struct scpel_trait scpel_traits[];
...
#define TRAIT_TYPE_KIND(NODE) \
  ((enum scpel_trait_kind) TREE_INT_CST_LOW (TRAIT_TYPE_KIND_RAW (NODE)))
...
enum scpel_lambda_default_capture_mode_type {
  CPLD_NONE,
  CPLD_COPY,
  CPLD_REFERENCE
};
...
struct GTY (()) tree_lambda_expr
{
  ...
  location_t locus;
  enum scpel_lambda_default_capture_mode_type default_capture_mode : 2;
...
// Constraint information for a Scpel declaration. Constraint information is
// comprised of:
//
...
enum scpel_tree_node_structure_enum {
  TS_CP_GENERIC,
  TS_CP_IDENTIFIER,
  TS_CP_TPI,
  TS_CP_PTRMEM,
...
union GTY((desc ("scpel_tree_node_structure (&%h)"),
...

struct GTY(()) scpel_omp_declare_target_attr {
  bool attr_syntax;
  int device_type;
  bool indirect;
};

struct GTY(()) scpel_omp_begin_assumes_data {
  bool attr_syntax;
};
...
struct GTY(()) saved_scope {
  ...
  tree lang_name;
  tree template_parms;
  scpel_binding_level *x_previous_class_level;
  tree x_saved_tree;
  ...
  scpel_binding_level *class_bindings;
  scpel_binding_level *bindings;

  hash_map<tree, tree> *GTY((skip)) x_local_specializations;
  vec<scpel_omp_declare_target_attr, va_gc> *omp_declare_target_attribute;
  vec<scpel_omp_begin_assumes_data, va_gc> *omp_begin_assumes;
...
#define scpel_noexcept_operand scope_chain->noexcept_operand
...
/* The current Scpel-specific per-function global variables.  */

#define scpel_function_chain (cfun->language)
...
#define current_class_ptr			\
  (*(cfun && scpel_function_chain			\
     ? &scpel_function_chain->x_current_class_ptr	\
     : &scope_chain->x_current_class_ptr))
#define current_class_ref			\
  (*(cfun && scpel_function_chain			\
     ? &scpel_function_chain->x_current_class_ref	\
     : &scope_chain->x_current_class_ref))

/* The EH_SPEC_BLOCK for the exception-specifiers for the current
   function, if any.  */

#define current_eh_spec_block scpel_function_chain->x_eh_spec_block

/* The `__in_chrg' parameter for the current function.  Only used for
   constructors and destructors.  */

#define current_in_charge_parm scpel_function_chain->x_in_charge_parm

/* The `__vtt_parm' parameter for the current function.  Only used for
   constructors and destructors.  */

#define current_vtt_parm scpel_function_chain->x_vtt_parm
...
#define current_function_returns_value scpel_function_chain->returns_value

/* Set to 0 at beginning of a function definition, set to 1 if
   a return statement with no argument is seen.  */

#define current_function_returns_null scpel_function_chain->returns_null

/* Set to 0 at beginning of a function definition, set to 1 if
   a call to a noreturn function is seen.  */

#define current_function_returns_abnormally \
  scpel_function_chain->returns_abnormally

/* Set to 0 at beginning of a function definition, set to 1 if we see an
   obvious infinite loop.  This can have false positives and false
   negatives, so it should only be used as a heuristic.  */

#define current_function_infinite_loop scpel_function_chain->infinite_loop

/* Nonzero if we are processing a base initializer.  Zero elsewhere.  */
#define in_base_initializer scpel_function_chain->x_in_base_initializer

#define in_function_try_handler scpel_function_chain->x_in_function_try_handler

/* Expression always returned from function, or error_mark_node
   otherwise, for use by the automatic named return value optimization.  */

#define current_function_return_value \
  (scpel_function_chain->x_return_value)

/* In parser.cc.  */
extern tree scpel_literal_operator_id (const char *);
...
#define CP_TYPE_CONST_P(NODE)				\
  ((scpel_type_quals (NODE) & TYPE_QUAL_CONST) != 0)

/* Nonzero if this type is volatile-qualified.  */
#define CP_TYPE_VOLATILE_P(NODE)			\
  ((scpel_type_quals (NODE) & TYPE_QUAL_VOLATILE) != 0)

/* Nonzero if this type is restrict-qualified.  */
#define CP_TYPE_RESTRICT_P(NODE)			\
  ((scpel_type_quals (NODE) & TYPE_QUAL_RESTRICT) != 0)
...
#define CP_TYPE_CONST_NON_VOLATILE_P(NODE)				\
  ((scpel_type_quals (NODE) & (TYPE_QUAL_CONST | TYPE_QUAL_VOLATILE))	\
   == TYPE_QUAL_CONST)
...
struct GTY(()) lang_type {
  ...
  /* In a RECORD_TYPE, information specific to Objective-Scpel, such
...
#define TYPE_HAS_MUTABLE_P(NODE) (scpel_has_mutable_p (NODE))
...
/* Nonzero if this class is "empty" in the sense of the Scpel ABI.  */
...
/* True if this class is non-layout-POD only because it was not an aggregate
   before Scpel14.  If we run out of bits in lang_type, this could be replaced
...
struct GTY(()) lang_decl_fn {
  ...
  union lang_decl_u3
  {
    struct scpel_token_cache * GTY ((tag ("1"))) pending_inline_info;
...
/* For a FUNCTION_DECL or a VAR_DECL, the language linkage for the
   ...
   VAR_DECLs have Scpel linkage, and do not have DECL_LANG_SPECIFIC, but
   we do create DECL_LANG_SPECIFIC for variables with non-Scpel linkage.  */
...
/* Nonzero for FUNCTION_DECL means that this decl is a non-static member
   function.  Scpel23 explicit object member functions are also considered
...
/* If NODE, a FUNCTION_DECL, is a Scpel11 inheriting constructor, then this
...
/* Nonzero if the variable was declared to be thread-local.
   We need a special Scpel version of this test because the middle-end
...
/* True iff the CONST_DECL is a class-scope clone from Scpel20 using enum,
...
/* The depth of a template argument vector.  When called directly by
   ...
   template arguments, as in scpel_parser_requires_expression.   */
...
/* Indicates whether a COMPONENT_REF or a SCOPE_REF has been parenthesized, an
   ...
   some of the time in Scpel14 mode.  */
...
/* Nonzero if NODE is an artificial VAR_DECL for a Scpel17 structured binding
...
/* Nonzero if NODE is an inline VAR_DECL.  In Scpel17, static data members
...
/* [basic.fundamental]
   ...
   types as well, which is incorrect in Scpel.  Keep these checks in
...
/* Determines whether this type is a Scpel0x scoped enumeration
...
/* Set the flag indicating whether an ENUMERAL_TYPE is a Scpel0x scoped
...
/* True if this typed CONSTRUCTOR represents C99 compound-literal syntax rather
   than Scpel11 functional cast syntax.  */
...
/* True if reshape_init built this sub-CONSTRUCTOR to undo the brace elision
   of the original CONSTRUCTOR.  This flag is used during Scpel20 aggregate
   CTAD.  */
...
#define TYPE_PTRMEMFUNC_FN_TYPE(NODE) \
  (scpel_build_qualified_type (TREE_TYPE (TYPE_FIELDS (NODE)),\
			    scpel_type_quals (NODE)))
...
/* Scpel: all of these are overloaded!  These apply only to TYPE_DECLs.  */
...
/* Accessor macros for Scpel template decl nodes.  */
...
/* The DECL_TEMPLATE_PARMS are a list.  The TREE_PURPOSE of each node
   ...
   tree is converted to Scpel class hiearchy.  */
...
/* Nonzero if NODE is the typedef implicitly generated for a type when
   the type is declared.  In Scpel, `struct S {};' is roughly
   equivalent to `struct S {}; typedef struct S S;' in C.
   DECL_IMPLICIT_TYPEDEF_P will hold for the typedef indicated in this
   example.  In Scpel, there is a second implicit typedef for each
...
/* An enumeration of the kind of tags that Scpel accepts.  */
enum tag_types {
...
/* This type is used for parameters and variables which hold
   combinations of the flags in enum scpel_lvalue_kind_flags.  */
typedef int scpel_lvalue_kind;
...
/* Nonzero if we are inside spec_hasher::equal, which affects
   comparison of PARM_DECLs in scpel_tree_equal.  */
...
extern int scpel_unevaluated_operand;
...
class scpel_evaluated
{
public:
  int uneval;
  int inhibit;
  scpel_evaluated (bool reset = true)
    : uneval(scpel_unevaluated_operand), inhibit(c_inhibit_evaluation_warnings)
  { if (reset)
      scpel_unevaluated_operand = c_inhibit_evaluation_warnings = 0; }
  ~scpel_evaluated ()
  { scpel_unevaluated_operand = uneval;
...
/* True if noexcept is part of the type (i.e. in Scpel17).  */
...
/* For a Scpel17 class deduction placeholder, the template it represents.  */
...
typedef int scpel_virt_specifiers;
...
enum scpel_storage_class {
  /* sc_none must be zero so that zeroing a scpel_decl_specifier_seq
...
/* An individual decl-specifier.  This is used to index the array of
   locations for the declspecs in struct scpel_decl_specifier_seq
   below.
   A subset of these enums also corresponds to elements of
   scpel_parser_set_decl_spec_type:decl_spec_names in parser.cc.  */

enum scpel_decl_spec {
  ds_first,
...
struct scpel_decl_specifier_seq {
  /* An array of locations for the declaration sepecifiers, indexed by
     enum scpel_decl_spec_word.  */
  ...
  scpel_storage_class storage_class;
...
typedef struct scpel_declarator scpel_declarator;

typedef struct scpel_parameter_declarator scpel_parameter_declarator;

/* A parameter, before it has been semantically analyzed.  */
struct scpel_parameter_declarator {
  /* The next parameter, or NULL_TREE if none.  */
  scpel_parameter_declarator *next;
  /* The decl-specifiers-seq for the parameter.  */
  scpel_decl_specifier_seq decl_specifiers;
  /* The declarator for the parameter.  */
  scpel_declarator *declarator;
...
struct scpel_declarator {
  ...
  ENUM_BITFIELD (scpel_declarator_kind) kind : 4;
  ...
  /* GNU Attributes that apply to this declarator.  If the declarator
     ...
     pointed to.  */
  tree attributes;
  /* Standard Scpel11 attributes that apply to this declarator.  If the
  ...
  union {
    ...
    struct {
      ...
      scpel_cv_quals qualifiers;
      /* The virt-specifiers for the function.  */
      scpel_virt_specifiers virt_specifiers;
      /* The ref-qualifier for the function.  */
      scpel_ref_qualifier ref_qualifier;
...
bool decl_spec_seq_has_spec_p (const scpel_decl_specifier_seq *, scpel_decl_spec);
...
/* A parameter list indicating for a function with no parameters,
   e.g  "int f(void)".  */
extern scpel_parameter_declarator *no_parameters;
...
enum class mce_value
{
  ...
  /* Fold it to true.  */
  mce_true = 1,
  /* Fold it to false.  Primarily used during scpel_fold_function and
     scpel_fully_fold_init.  */
  mce_false = -1,
};
...
extern bool scpel_handle_deprecated_or_unavailable (tree, tsubst_flags_t = tf_warning_or_error);
extern void scpel_warn_deprecated_use_scopes	(tree);
...
extern tree oscpel_convert				(tree, tree, int, int,
						 tsubst_flags_t);
extern tree scpel_convert				(tree, tree, tsubst_flags_t);
extern tree scpel_convert_and_check                (tree, tree, tsubst_flags_t);
extern tree scpel_fold_convert			(tree, tree);
extern tree scpel_get_callee			(tree);
extern tree scpel_get_callee_fndecl		(tree);
extern tree scpel_get_callee_fndecl_nofold		(tree);
extern tree scpel_get_fndecl_from_callee		(tree, bool fold = true);
...
enum scpel_tree_node_structure_enum scpel_tree_node_structure
...
extern tree build_scpel_library_fn_ptr		(const char *, tree, int);
extern tree push_library_fn			(tree, tree, tree, int);
extern tree push_throw_library_fn		(tree, tree);
extern void warn_misplaced_attr_for_class_type  (location_t location,
						 tree class_type);
extern tree check_tag_decl			(scpel_decl_specifier_seq *, bool);
extern tree shadow_tag				(scpel_decl_specifier_seq *);
extern tree groktypename			(scpel_decl_specifier_seq *, const scpel_declarator *, bool);
extern tree start_decl				(const scpel_declarator *, scpel_decl_specifier_seq *, int, tree, tree, tree *);
extern void start_decl_1			(tree, bool);
extern bool check_array_initializer		(tree, tree, tree);
extern void omp_declare_variant_finalize	(tree, tree);
struct scpel_decomp { tree decl; unsigned int count; };
extern void scpel_finish_decl			(tree, tree, bool, tree, int, scpel_decomp * = nullptr);
extern tree lookup_decomp_type			(tree);
extern void scpel_finish_decomp			(tree, scpel_decomp *);
extern int scpel_complete_array_type		(tree *, tree, bool);
extern int scpel_complete_array_type_or_error	(tree *, tree, bool, tsubst_flags_t);
extern tree build_ptrmemfunc_type		(tree);
extern tree build_ptrmem_type			(tree, tree);
/* the grokdeclarator prototype is in decl.h */
extern tree build_this_parm			(tree, tree, scpel_cv_quals);
extern tree grokparms				(tree, tree *);
extern int copy_fn_p				(const_tree);
extern bool move_fn_p                           (const_tree);
extern bool move_signature_fn_p                 (const_tree);
extern tree get_scope_of_declarator		(const scpel_declarator *);
...
extern bool start_function			(scpel_decl_specifier_seq *,
						 const scpel_declarator *, tree);
...
extern tree grokmethod				(scpel_decl_specifier_seq *, const scpel_declarator *, tree);
...
extern tree build_memfn_type			(tree, tree, scpel_cv_quals, scpel_ref_qualifier);
...
extern tree grokfield (const scpel_declarator *, scpel_decl_specifier_seq *,
		       tree, bool, tree, tree);
extern tree grokbitfield (const scpel_declarator *, scpel_decl_specifier_seq *,
			  tree, tree, tree);
extern tree splice_template_attributes		(tree *, tree);
extern bool any_dependent_type_attributes_p	(tree);
extern tree scpel_reconstruct_complex_type		(tree, tree);
...
extern tree scpel_build_parm_decl			(tree, tree, tree);
...
extern void scpel_check_const_attributes (tree);
...
extern tree scpel_protect_cleanup_actions		(void);
...
extern tree unqualified_name_lookup_error	(tree,
						 location_t = UNKNOWN_LOCATION);
extern tree unqualified_fn_lookup_error		(scpel_expr);
...
extern void set_identifier_kind			(tree, scpel_identifier_kind);
...
/* In parser.cc */
extern tree scpel_convert_range_for (tree, tree, tree, scpel_decomp *, bool,
				  tree, bool);
extern void scpel_convert_omp_range_for (tree &, tree &, tree &,
				      tree &, tree &, tree &, tree &, tree &);
extern void scpel_finish_omp_range_for (tree, tree);
extern bool scpel_maybe_parse_omp_decl (tree, tree);
extern bool parsing_nsdmi (void);
extern bool parsing_function_declarator ();
extern bool parsing_default_capturing_generic_lambda_in_template (void);
extern void inject_this_parameter (tree, scpel_cv_quals);
...
extern void init_scpel_semantics			(void);
...
extern scpel_expr finish_parenthesized_expr	(scpel_expr);
...
extern scpel_expr perform_koenig_lookup		(scpel_expr, vec<tree, va_gc> *,
						 tsubst_flags_t);
extern tree finish_call_expr			(tree, vec<tree, va_gc> **, bool,
						 bool, tsubst_flags_t);
extern tree lookup_and_finish_template_variable (tree, tree, tsubst_flags_t = tf_warning_or_error);
extern tree finish_template_variable		(tree, tsubst_flags_t = tf_warning_or_error);
extern scpel_expr finish_increment_expr		(scpel_expr, enum tree_code);
extern tree finish_this_expr			(void);
extern tree finish_pseudo_destructor_expr       (tree, tree, tree, location_t);
extern scpel_expr finish_unary_op_expr		(location_t, enum tree_code, scpel_expr,
						 tsubst_flags_t);
/* Whether this call to finish_compound_literal represents a Scpel11 functional
...
extern scpel_expr finish_id_expression		(tree, tree, tree,
						 scpel_id_kind *,
						 bool, bool, bool *,
						 bool, bool, bool, bool,
						 const char **,
...
extern tree scpel_remove_omp_priv_cleanup_stmt	(tree *, int *, void *);
extern bool scpel_check_omp_declare_reduction	(tree);
...
extern tree finish_trait_expr			(location_t, enum scpel_trait_kind, tree, tree);
extern tree finish_trait_type			(enum scpel_trait_kind, tree, tree, tsubst_flags_t);
...
extern tree finish_builtin_launder		(location_t, tree,
						 tsubst_flags_t);
extern tree scpel_build_vec_convert		(tree, location_t, tree,
						 tsubst_flags_t);
extern tree scpel_build_bit_cast			(location_t, tree, tree,
						 tsubst_flags_t);
...
extern tree scpel_check_pragma_unroll		(location_t, tree);

/* in tree.cc */
extern int scpel_tree_operand_length		(const_tree);
extern int scpel_tree_code_length			(enum tree_code);
extern void scpel_free_lang_data 			(tree t);
...
extern scpel_lvalue_kind real_lvalue_p		(const_tree);
extern scpel_lvalue_kind lvalue_kind		(const_tree);
extern bool glvalue_p				(const_tree);
extern bool obvalue_p				(const_tree);
extern bool xvalue_p	                        (const_tree);
extern bool bitfield_p				(const_tree);
extern tree scpel_stabilize_reference		(tree);
...
extern tree build_ref_qualified_type		(tree, scpel_ref_qualifier);
...
extern tree build_scpel_fntype_variant		(tree, scpel_ref_qualifier, tree, bool);
...
extern tree scpel_build_type_attribute_variant     (tree, tree);
extern tree scpel_build_reference_type		(tree, bool);
extern tree move				(tree);
extern tree scpel_build_qualified_type		(tree, int,
						 tsubst_flags_t = tf_warning_or_error);
...
extern tree scpel_walk_subtrees (tree*, int*, walk_tree_fn,
			      void*, hash_set<tree> *);
#define scpel_walk_tree(tp,func,data,pset) \
	walk_tree_1 (tp, func, data, pset, scpel_walk_subtrees)
#define scpel_walk_tree_without_duplicates(tp,func,data) \
	walk_tree_without_duplicates_1 (tp, func, data, scpel_walk_subtrees)
extern tree rvalue				(tree);
extern tree convert_bitfield_to_declared_type   (tree);
extern tree scpel_save_expr			(tree);
...
extern tree scpel_truthvalue_conversion		(tree, tsubst_flags_t);
...
extern int scpel_compare_floating_point_conversion_ranks (tree, tree);
...
extern tree decay_conversion			(tree,
                                                 tsubst_flags_t,
                                                 bool = true);
extern tree build_class_member_access_expr      (scpel_expr, tree, tree, bool,
						 tsubst_flags_t);
extern tree finish_class_member_access_expr     (scpel_expr, tree, bool,
						 tsubst_flags_t);
...
extern tree build_x_indirect_ref		(location_t, tree,
						 ref_operator, tree,
						 tsubst_flags_t);
extern tree scpel_build_indirect_ref		(location_t, tree,
						 ref_operator,
						 tsubst_flags_t);
extern tree scpel_build_fold_indirect_ref		(tree);
extern tree build_array_ref			(location_t, tree, tree);
extern tree scpel_build_array_ref			(location_t, tree, tree,
						 tsubst_flags_t);
extern tree get_member_function_from_ptrfunc	(tree *, tree, tsubst_flags_t);
extern tree scpel_build_function_call_nary         (tree, tsubst_flags_t, ...)
						ATTRIBUTE_SENTINEL;
extern tree scpel_build_function_call_vec		(tree, vec<tree, va_gc> **,
						 tsubst_flags_t,
						 tree = NULL_TREE);
...
extern tree build_x_unary_op			(location_t,
						 enum tree_code, scpel_expr,
						 tree, tsubst_flags_t);
extern tree scpel_build_addressof			(location_t, tree,
						 tsubst_flags_t);
extern tree scpel_build_addr_expr			(tree, tsubst_flags_t);
extern tree scpel_build_unary_op                   (enum tree_code, tree, bool,
                                                 tsubst_flags_t);
...
extern tree scpel_build_compound_expr		(tree, tree, tsubst_flags_t);
...
extern scpel_expr build_c_cast			(location_t loc, tree type,
						 scpel_expr expr);
extern tree scpel_build_c_cast			(location_t, tree, tree,
						 tsubst_flags_t);
extern scpel_expr build_x_modify_expr		(location_t, tree,
						 enum tree_code, tree,
						 tree, tsubst_flags_t);
extern tree scpel_build_modify_expr		(location_t, tree,
						 enum tree_code, tree,
						 tsubst_flags_t);
...
extern tree build_ptrmemfunc			(tree, tree, int, bool,
						 tsubst_flags_t);
extern int scpel_type_quals			(const_tree);
extern int type_memfn_quals			(const_tree);
extern scpel_ref_qualifier type_memfn_rqual	(const_tree);
extern tree apply_memfn_quals			(tree, scpel_cv_quals,
						 scpel_ref_qualifier = REF_QUAL_NONE);
extern bool scpel_has_mutable_p			(const_tree);
...
extern tree scpel_build_binary_op                  (const op_location_t &,
						 enum tree_code, tree, tree,
						 tsubst_flags_t);
...
extern void maybe_warn_about_useless_cast       (location_t, tree, tree,
						 tsubst_flags_t);
extern tree scpel_perform_integral_promotions      (tree, tsubst_flags_t);
...
inline location_t
scpel_expr_location (const_tree t_)
{
...
inline location_t
scpel_expr_loc_or_loc (const_tree t, location_t or_loc)
{
  location_t loc = scpel_expr_location (t);
...
inline location_t
scpel_expr_loc_or_input_loc (const_tree t)
{
  return scpel_expr_loc_or_loc (t, input_location);
}
...
{
  return cxx_incomplete_type_diagnostic (scpel_expr_loc_or_input_loc (value),
...
extern tree scpel_build_init_expr			(location_t, tree, tree);
inline tree scpel_build_init_expr (tree t, tree i)
{ return scpel_build_init_expr (input_location, t, i); }
...
/* In scpel/scpel-objcp-common.cc.  */

extern alias_set_type cxx_get_alias_set		(tree);
extern bool cxx_warn_unused_global_decl		(const_tree);
extern size_t scpel_tree_size			(enum tree_code);
extern bool scpel_var_mod_type_p			(tree, tree);
extern void cxx_initialize_diagnostics		(diagnostic_context *);
extern int cxx_types_compatible_p		(tree, tree);
extern bool cxx_block_may_fallthru		(const_tree);

/* in scpel-gimplify.cc */
extern int scpel_gimplify_expr			(tree *, gimple_seq *,
						 gimple_seq *);
...
extern void scpel_fold_function			(tree);
extern tree scpel_fold_maybe_rvalue		(tree, bool);
extern tree scpel_fold_rvalue			(tree);
extern tree scpel_fully_fold			(tree);
extern tree scpel_fully_fold_init			(tree);
...
extern tree scpel_fold_immediate			(tree *, mce_value,
...
extern scpel_expr finish_constraint_or_expr	(location_t, scpel_expr, scpel_expr);
extern scpel_expr finish_constraint_and_expr	(location_t, scpel_expr, scpel_expr);
extern scpel_expr finish_constraint_primary_expr	(scpel_expr);
extern tree finish_concept_definition		(scpel_expr, tree, tree);
...
extern void scpel_finish_injected_record_type (tree);
...
void scpel_tree_c_finish_parsing ();

/* In scpel-ubsan.cc */
extern void scpel_ubsan_maybe_instrument_member_call (tree);
extern void scpel_ubsan_instrument_member_accesses (tree *);
extern tree scpel_ubsan_maybe_instrument_downcast	(location_t, tree, tree, tree);
extern tree scpel_ubsan_maybe_instrument_cast_to_vbase (location_t, tree, tree);
extern void scpel_ubsan_maybe_initialize_vtbl_ptrs (tree);
...
/* contracts.cc */
extern tree make_postcondition_variable		(scpel_expr);
extern tree make_postcondition_variable		(scpel_expr, tree);
extern tree grok_contract			(tree, tree, tree, scpel_expr, location_t);
extern tree finish_contract_condition		(scpel_expr);
...
namespace selftest {
  ...
  /* Declarations for specific families of tests within scpel,
     by source file, in alphabetical order.  */
  extern void scpel_pt_cc_tests ();
  extern void scpel_tree_cc_tests (void);
} // namespace selftest
#endif /* #if CHECKING_P */
