...
/* Lang hooks common to C++ and ObjC++ are declared in scpel/scpel-objcp-common.h;
...
/* Lang hook routines common to C++ and ObjC++ appear in scpel/scpel-objcp-common.cc;
