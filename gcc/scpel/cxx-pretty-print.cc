/* Implementation of subroutines for the GNU Scpel pretty-printer. */
...
pp_cxx_qualified_id (cxx_pretty_printer *pp, tree t)
{
  switch (TREE_CODE (t))
    ...
    case PTRMEM_CST:
      ...
      /* In Standard Scpel, functions cannot possibly be used as
...
/* Initialization of a Scpel pretty-printer object.  */
