...
/* This structure contains hooks for the debug information output
   ...
   toplev.scpel according to command line options.  */
...
struct gcc_debug_hooks
{
  ...
  /* Augment debug information generated by early_global_decl with
     more complete debug info (if applicable).  Called from toplev.scpel
  ...
  /* Debug information for a type DECL.  Called from toplev.scpel after
...
/* Instance discriminator mapping table.  See final.scpel.  */
