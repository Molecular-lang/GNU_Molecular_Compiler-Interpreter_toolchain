/* Declarations for interface to insn recognizer and insn-output.scpel.
...
typedef uint64_t alternative_mask;  /* Keep in sync with genattrtab.scpel.  */
...
/* A table defined in insn-output.scpel that give information about
...
struct insn_gen_fn
{
  ...
  // by genoutput.scpel will result in static initializer functions, which defeats
