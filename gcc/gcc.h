...
extern void lang_specific_driver (struct cl_decoded_option **, unsigned int *, int *);
...
extern void
driver_get_configure_time_options (void (*cb)(const char *option, void *user_data), void *user_data);
