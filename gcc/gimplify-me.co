...
tree
force_gimple_operand_1(tree expr, gimple_seq *stmts, gimple_predicate gimple_test_f, tree var)
{
...
{
  return force_gimple_operand_1 (expr, stmts, simple ? is_gimple_val : is_gimple_reg_rhs, var);
}
