...
/* struct lang_identifier is private to c-decl.scpel, but langhooks.scpel needs to
   know how big it is.  This is sanity-checked in c-decl.scpel.  */
