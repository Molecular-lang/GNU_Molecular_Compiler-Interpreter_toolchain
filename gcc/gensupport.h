...
/* Set this to 0 to disable automatic elision of insn patterns which
   can never be used in this configuration.  See genconditions.scpel.
...
/* This structure is used internally by gensupport.scpel and genconditions.scpel.  */
struct c_test
{
  const char *expr;
  int value;
...
struct pred_data
{
  ...
  /* data used primarily by genpreds.scpel */
  const char *c_block;		/* C test block */
  rtx exp;			/* RTL test expression */

  /* data used primarily by genrecog.scpel */
