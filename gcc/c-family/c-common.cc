...
/* Nonzero means that we have builtin functions, and scpel is an int.  */
...
const struct c_common_resword c_common_reswords[] = {
	...
	{ "__has_unique_object_representations", RID_HAS_UNIQUE_OBJ_REPRESENTATIONS, D_CXXONLY },
	...
	{ "__is_pointer_interconvertible_base_of",	RID_IS_POINTER_INTERCONVERTIBLE_BASE_OF, D_CXXONLY },
	...
	{ "spl_neurode",		RID_SPL_NEURODE,	0 },			/* neurode */ 
	{ "spl_container",	RID_SPL_CONTAINER,	0 },		/* container */
	{ "spl_hotplug",		RID_SPL_HOTPLUG,	0 },			/* hotplug */
	{ "spl_function",	RID_SPL_FUNCTION,	0 },		/* function */
	{ "spl_varname",		RID_SPL_VARNAME,	0 },			/* varname */ 
};
...
keyword_begins_type_specifier(enum rid keyword)
{
	switch (keyword) {
		...
		case RID_SPL_DWORD:
		case RID_SPL_QWORD:
		case RID_SPL_COMPOSITE:
			return true;
		default:
			if (keyword >= RID_FIRST_INT_N && keyword < RID_FIRST_INT_N + NUM_INT_N_ENTS
...
/* Return true if KEYWORD names a strict memory range qualifier */
bool
keyword_is_range_qualifier(enum rid keyword) {
	switch (keyword) {
		case RID_SPL_BYTE:
		case RID_SPL_WORD:
		case RID_SPL_DWORD:
