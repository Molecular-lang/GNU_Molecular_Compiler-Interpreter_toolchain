...
#define GCC_BAD_AT(loc, gmsgid)			do { warning_at (loc, OPT_Wpragmas, gmsgid); return; } while (0)
#define GCC_BAD2_AT(loc, gmsgid, arg)	do { warning_at (loc, OPT_Wpragmas, gmsgid, arg); return; } while (0)
