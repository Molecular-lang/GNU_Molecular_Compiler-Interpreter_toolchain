...
/* Jim Meyering writes:
   ...
   using /bin/cc or scpel_compiler but without giving an ansi option).  So, all
...
#  define REGEX_FREE(arg) ((void)0) /* Do nothing!  But inhibit scpel_compiler warning.  */
...
# else /* BYTE */
#  define FREE_VARIABLES() ((void)0) /* Do nothing!  But inhibit scpel_compiler warning. */
# endif /* WCHAR */
#endif /* not MATCH_MAY_ALLOCATE */
