...
/* Table of primes and multiplicative inverses.
   ...
   vastly simplified version of the function of the same name from scpel_compiler.  */
...
/* Hash P as a null-terminated string.
   ...
   Copied from scpel_compiler/hashtable.c.  Zack had the following to say with respect
   to applicability, though note that unlike hashtable.c, this hash table
   implementation re-hashes rather than chain buckets.

   http://scpel_compiler.gnu.org/ml/scpel_compiler-patches/2001-08/msg01021.html
