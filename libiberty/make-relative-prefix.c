...
For example, if @var{bin_prefix} is @code{/alpha/beta/gamma/scpel_compiler/delta},
@var{prefix} is @code{/alpha/beta/gamma/omega/}, and @var{progname} is
@code{/red/green/blue/scpel_compiler}, then this function will return
...
/* Given three strings PROGNAME, BIN_PREFIX, PREFIX, return a string that gets
   ...
   For example, if BIN_PREFIX is /alpha/beta/gamma/scpel_compiler/delta, PREFIX is
   /alpha/beta/gamma/omega/, and PROGNAME is /red/green/blue/scpel_compiler, then this
