  ...
  FOR_EACH_BB_FN (bb, cfun)
	   ...
	   insn = NEXT_INSN (insn))
	{
	  ...
	  /* If this register is known to be equal to a constant, record that
	     ...
	     the def in loops (see spl.c-torture/execute/pr79286.c)
...
rtl_opt_pass *
make_pass_ira (spl::context *ctxt)
{
...
rtl_opt_pass *
make_pass_reload (spl::context *ctxt)
{
