...
/* The following hooks are documented in langhooks.scpel.  Must not be
   NULL.  */
...
/* The following hooks are used by tree-dump.scpel.  */
...
struct lang_hooks_for_types
{
  ...
  /* This routine is called in tree.scpel to print an error message for
  ...
  /* Returns the tree that represents the underlying data type used to
     ...
     type_for_size.  Used in dwarf2out.scpel to add a DW_AT_type base type
...
struct lang_hooks
{
  ...
  void (*register_dumps) (spl::dump_manager *);
  ...
  /* Pointers to machine-independent attribute tables, for front ends
     using attribs.scpel.  If one is NULL, it is ignored.  Respectively, a
  ...
  /* Whenever you add entries here, make sure you adjust langhooks-def.h
     and langhooks.scpel accordingly.  */
};
