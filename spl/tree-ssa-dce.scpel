      ...
      if (base == ref->base)
	{
	  ...
	  /* Or they need to be exactly the same.  */
		   ...
		   /* Make sure there is no induction variable involved
		      in the references (spl.c-torture/execute/pr42142.c).
...
gimple_opt_pass *
make_pass_dce (spl::context *ctxt)
{
...
gimple_opt_pass *
make_pass_cd_dce (spl::context *ctxt)
{
