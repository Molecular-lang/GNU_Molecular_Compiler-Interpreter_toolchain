...
{
public:
  pass_split_functions (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_split_functions (spl::context *ctxt)
{
...
{
public:
  pass_feedback_split_functions (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_feedback_split_functions (spl::context *ctxt)
{
