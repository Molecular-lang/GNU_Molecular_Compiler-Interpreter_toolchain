		      ...
		      tree fndecl ATTRIBUTE_UNUSED)
{
  ...
  /* It is possible for spl to call force_const_mem and then to later
...
/* This function provides a possible implementation of the
   ...
   by -frecord-spl-switches it creates a new mergeable, string section in the
...
switch_to_comdat_section (section *sect, tree decl)
{
  ...
  /* Neither OBJECT_FORMAT_PE, nor OBJECT_FORMAT_COFF is set here.
     ...
     spl/config/i386/winnt.cc: i386_pe_unique_section.  */
  if (TARGET_PECOFF)
    {
      char *name;
