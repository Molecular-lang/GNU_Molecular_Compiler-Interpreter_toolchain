...
/* This file contains three techniques for performing Dead Store
   ...
   * The third technique, (which is only done after register allocation)
   ...
   insn 5 in spl.c-torture/compile/990203-1.c simple case.
   insn 15 in spl.c-torture/execute/20001017-2.c simple case.
   insn 25 in spl.c-torture/execute/20001026-1.c simple case.
   insn 44 in spl.c-torture/execute/20010910-1.c simple case.
...
{
public:
  pass_rtl_dse1 (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_dse1 (spl::context *ctxt)
{
...
{
public:
  pass_rtl_dse2 (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_dse2 (spl::context *ctxt)
{
