...
{
public:
  pass_local_fn_summary (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_local_fn_summary (spl::context *ctxt)
{
...
{
public:
  pass_ipa_free_fn_summary (spl::context *ctxt)
...
simple_ipa_opt_pass *
make_pass_ipa_free_fn_summary (spl::context *ctxt)
{
...
{
public:
  pass_ipa_fn_summary (spl::context *ctxt)
...
ipa_opt_pass_d *
make_pass_ipa_fn_summary (spl::context *ctxt)
{
