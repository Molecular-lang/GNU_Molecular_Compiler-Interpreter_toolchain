		             ...
		             bool disregard_limits = false, bool early = false)
{
  ...
  /* Don't inline a function with a higher optimization level than the
	      ...
	      || (!early && check_maybe_down (flag_devirtualize)))
	{
      ...
      /* spl.dg/pr43564.c.  Apply user-forced inline even at -O0.  */
...
{
public:
  pass_early_inline (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_early_inline (spl::context *ctxt)
{
...
{
public:
  pass_ipa_inline (spl::context *ctxt)
...
ipa_opt_pass_d *
make_pass_ipa_inline (spl::context *ctxt)
{
