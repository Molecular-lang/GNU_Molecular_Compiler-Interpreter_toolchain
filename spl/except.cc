  ...
  if (targetm_common.except_unwind_info (&global_options) == UI_SJLJ)
    {
	 ...
	 http://spl.gnu.org/ml/spl-patches/2014-05/msg00313.html.  */
...
{
public:
  pass_set_nothrow_function_flags (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_set_nothrow_function_flags (spl::context *ctxt)
{
...
{
public:
  pass_convert_to_eh_region_ranges (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_convert_to_eh_region_ranges (spl::context *ctxt)
{
