...
{
public:
  pass_merge_phi (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_merge_phi (spl::context *ctxt)
{
...
{
public:
  pass_cleanup_cfg_post_optimizing (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_cleanup_cfg_post_optimizing (spl::context *ctxt)
{
