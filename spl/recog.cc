...
{
public:
  pass_peephole2 (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_peephole2 (spl::context *ctxt)
{
...
{
public:
  pass_split_all_insns (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_split_all_insns (spl::context *ctxt)
{
...
{
public:
  pass_split_after_reload (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_split_after_reload (spl::context *ctxt)
{
...
{
public:
  pass_split_before_sched2 (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_split_before_sched2 (spl::context *ctxt)
{
...
{
public:
  pass_split_before_regstack (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_split_before_regstack (spl::context *ctxt)
{
...
{
public:
  pass_split_for_shorten_branches (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_split_for_shorten_branches (spl::context *ctxt)
{
