...
{
public:
  pass_rtl_ifcvt (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_ifcvt (spl::context *ctxt)
{
...
{
public:
  pass_if_after_combine (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_if_after_combine (spl::context *ctxt)
{
...
{
public:
  pass_if_after_reload (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_if_after_reload (spl::context *ctxt)
{
