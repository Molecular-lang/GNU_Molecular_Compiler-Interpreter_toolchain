...
{
public:
  pass_lower_complex (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_complex (spl::context *ctxt)
{
...
{
public:
  pass_lower_complex_O0 (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_complex_O0 (spl::context *ctxt)
{
