...
{
public:
  pass_ipa_whole_program_visibility (spl::context *ctxt)
...
ipa_opt_pass_d *
make_pass_ipa_whole_program_visibility (spl::context *ctxt)
{
...
{
public:
  pass_ipa_function_and_variable_visibility (spl::context *ctxt)
