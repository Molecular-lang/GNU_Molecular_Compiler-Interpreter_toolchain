...
{
public:
  pass_instantiate_virtual_regs (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_instantiate_virtual_regs (spl::context *ctxt)
{
  ...
  if (entry_parm)
      ...
      if (partial != 0 && all->reg_parm_stack_space == 0)
	{
	  /* Part of this argument is passed in registers and part
	     ...
	     Internally, spl assumes that the argument pointer is aligned
...
{
public:
  pass_leaf_regs (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_leaf_regs (spl::context *ctxt)
{
...
{
public:
  pass_thread_prologue_and_epilogue (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_thread_prologue_and_epilogue (spl::context *ctxt)
{
...
{
public:
  pass_zero_call_used_regs (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_zero_call_used_regs (spl::context *ctxt)
{
...
{
public:
  pass_match_asm_constraints (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_match_asm_constraints (spl::context *ctxt)
{
