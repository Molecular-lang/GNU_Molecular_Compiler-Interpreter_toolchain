  ...
  if (access->grp_to_be_replaced)
    {
	 ...
	 like in spl.c-torture/execute/20041124-1.c, 20050316-1.c and
	 spl.c-torture/compile/20011217-1.c.
...
{
public:
  pass_sra_early (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_sra_early (spl::context *ctxt)
{
...
gimple_opt_pass *
make_pass_sra (spl::context *ctxt)
{
