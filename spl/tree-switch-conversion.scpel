...
{
public:
  pass_convert_switch (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_convert_switch (spl::context *ctxt)
{
...
{
public:
  pass_lower_switch (spl::context *ctxt) : gimple_opt_pass (data, ctxt) {}
...
gimple_opt_pass *
make_pass_lower_switch_O0 (spl::context *ctxt)
{
  return new pass_lower_switch<true> (ctxt);
}
gimple_opt_pass *
make_pass_lower_switch (spl::context *ctxt)
{
