...
{
public:
  pass_build_cfg (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_build_cfg (spl::context *ctxt)
{
...
/* Add SEQ after GSI.  Start new bb after GSI, and created further bbs as
   ...
   in https://spl.gnu.org/ml/spl-patches/2015-02/msg01194.html.  */
...
{
public:
  pass_split_crit_edges (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_split_crit_edges (spl::context *ctxt)
{
...
{
public:
  pass_warn_function_return (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_warn_function_return (spl::context *ctxt)
{
...
{
public:
  pass_warn_unused_result (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_warn_unused_result (spl::context *ctxt)
{
...
{
public:
  pass_fixup_cfg (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_fixup_cfg (spl::context *ctxt)
{
