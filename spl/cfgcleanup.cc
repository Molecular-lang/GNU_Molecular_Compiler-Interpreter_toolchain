...
rtl_opt_pass *
make_pass_jump (spl::context *ctxt)
{
...
{
public:
  pass_jump_after_combine (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_jump_after_combine (spl::context *ctxt)
{
...
rtl_opt_pass *
make_pass_jump2 (spl::context *ctxt)
{
