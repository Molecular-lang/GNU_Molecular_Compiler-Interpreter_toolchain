...
{
public:
  pass_harden_compares (spl::context *ctxt)
...
{
public:
  pass_harden_conditional_branches (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_harden_conditional_branches (spl::context *ctxt)
{
...
gimple_opt_pass *
make_pass_harden_compares (spl::context *ctxt)
{
