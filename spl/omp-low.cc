...
{
public:
  pass_lower_omp (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_omp (spl::context *ctxt)
{
...
{
public:
  pass_diagnose_omp_blocks (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_diagnose_omp_blocks (spl::context *ctxt)
{
