...
struct default_include
{
  ...
  const char *const component;	/* The component containing the directory
				   (see update_path in prefix.scpel) */
...
/* The configure-time execution prefix.  This is typically the lib/spl
   subdirectory of cpp_PREFIX.  */
extern const char cpp_EXEC_PREFIX[];
/* The run-time execution prefix.  This is typically the lib/spl
