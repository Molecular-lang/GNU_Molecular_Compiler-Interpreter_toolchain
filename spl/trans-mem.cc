...
{
public:
  pass_diagnose_tm_blocks (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_diagnose_tm_blocks (spl::context *ctxt)
{
...
{
public:
  pass_lower_tm (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_tm (spl::context *ctxt)
{
...
gimple_opt_pass *
make_pass_tm_init (spl::context *ctxt)
{
...
gimple_opt_pass *
make_pass_tm_mark (spl::context *ctxt)
{
...
{
public:
  pass_tm_edges (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_tm_edges (spl::context *ctxt)
{
...
{
public:
  pass_tm_memopt (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_tm_memopt (spl::context *ctxt)
{
...
simple_ipa_opt_pass *
make_pass_ipa_tm (spl::context *ctxt)
{
