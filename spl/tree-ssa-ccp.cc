...
ccp_lattice_meet (ccp_prop_value_t *val1, ccp_prop_value_t *val2)
{
  if (val1->lattice_val == UNDEFINED
	 ...
	 also causes a lot of spl.dg/uninit-pred*.c FAILs.  */
...
gimple_opt_pass *
make_pass_ccp (spl::context *ctxt)
{
...
{
public:
  pass_fold_builtins (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_fold_builtins (spl::context *ctxt)
{
...
{
public:
  pass_post_ipa_warn (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_post_ipa_warn (spl::context *ctxt)
{
