...
{
public:
  pass_cse_reciprocals (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_cse_reciprocals (spl::context *ctxt)
{
...
{
public:
  pass_cse_sincos (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_cse_sincos (spl::context *ctxt)
{
...
{
public:
  pass_expand_powcabs (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_expand_powcabs (spl::context *ctxt)
{
...
{
public:
  pass_optimize_widening_mul (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_optimize_widening_mul (spl::context *ctxt)
{
