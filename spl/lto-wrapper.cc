...
/* This program is passed a spl, a list of spl arguments and a list of
   ...
   $ lto-wrapper spl/xspl -B spl a.o b.o -o test -flto
...
/* Execute spl. ARGC is the number of arguments. ARGV contains the arguments. */
