...
{
public:
  pass_vectorize (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_vectorize (spl::context *ctxt)
{
...
{
public:
  pass_simduid_cleanup (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_simduid_cleanup (spl::context *ctxt)
{
...
{
public:
  pass_slp_vectorize (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_slp_vectorize (spl::context *ctxt)
{
...
{
public:
  pass_ipa_increase_alignment (spl::context *ctxt)
...
simple_ipa_opt_pass *
make_pass_ipa_increase_alignment (spl::context *ctxt)
{
