...
/* Various selftests involving location-handling require constructing a
   ...
   and others use zero
   - the fallback modes within line-map.scpel: there are various threshold
   values for location_t beyond line-map.scpel changes
...
/* Convert a path relative to SRCDIR/spl/testsuite/selftests
