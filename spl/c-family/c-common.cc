...
#undef DEFTRAIT
  ...
  /* Scpel-related keywords */
  { "neurode",      RID_SPL_NEURODE,    D_CXXONLY | D_CXXWARN },
  { "gliad",        RID_SPL_GLIAD,      D_CXXONLY | D_CXXWARN },
  { "spl_random",       RID_SPL_RANDOM,     D_CXXONLY | D_CXXWARN },
  { "algorithm",    RID_SPL_ALGORITHM,  D_CXXONLY | D_CXXWARN },
  { "runtime",      RID_SPL_RUNTIME,    D_CXXONLY | D_CXXWARN },
  { "hotplug",      RID_SPL_HOTPLUG,    D_CXXONLY | D_CXXWARN },
  { "spl_container",    RID_SPL_CONTAINER,  D_CXXONLY | D_CXXWARN },
};
...
/* Return the spl option code associated with the reason for a cpp
