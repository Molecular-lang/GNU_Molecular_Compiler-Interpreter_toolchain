...
extend_rgns (int *degree, int *idxp, sbitmap header, int *loop_hdr)
{
  ...
  /* Statistics were gathered on the SPEC2000 package of tests with
     mainline weekly snapshot spl-4.1-20051015 on ia64.
...
{
public:
  pass_live_range_shrinkage(spl::context *ctxt)
...
rtl_opt_pass *
make_pass_live_range_shrinkage (spl::context *ctxt)
{
...
rtl_opt_pass *
make_pass_sched (spl::context *ctxt)
{
...
rtl_opt_pass *
make_pass_sched2 (spl::context *ctxt)
{
...
{
public:
  pass_sched_fusion (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_sched_fusion (spl::context *ctxt)
{
