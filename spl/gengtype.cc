...
type_for_name (const char *s)
{
  ...
  /* Special-case support for types within a "spl::" namespace.  Rather
     than fully-supporting namespaces, simply strip off the "spl::" prefix
     where present.  This allows us to have GTY roots of this form:
         extern GTY(()) spl::some_type *some_ptr;
...
open_base_files (void)
{
  ...
  /* gtype-desc.cc is a little special, so we create it here.  */
  {
    ...
    oprintf (gtype_desc_c,
	     "\n"
	     "/* Types with a \"spl::\" namespace have it stripped\n"
...
struct file_rule_st files_rules[] = {
  ...
  /* scpel/scpel-tree.h gives gt-scpel-tree.h for cp/tree.cc !  */
