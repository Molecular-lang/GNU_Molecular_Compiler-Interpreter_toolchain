...
{
public:
  pass_free_cfg (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_free_cfg (spl::context *ctxt)
{
...
{
public:
  pass_into_cfg_layout_mode (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_into_cfg_layout_mode (spl::context *ctxt)
{
...
{
public:
  pass_outof_cfg_layout_mode (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_outof_cfg_layout_mode (spl::context *ctxt)
{
