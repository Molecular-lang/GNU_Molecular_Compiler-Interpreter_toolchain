...
{
public:
  pass_compute_alignments (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_compute_alignments (spl::context *ctxt)
{
...
/* Map DECLs to instance discriminators.  This is allocated and
   defined in ada/spl-interfaces/trans.cc, when compiling with -gnateS.
...
rtl_opt_pass *
make_pass_final (spl::context *ctxt)
{
...
{
public:
  pass_shorten_branches (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_shorten_branches (spl::context *ctxt)
{
...
{
public:
  pass_clean_state (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_clean_state (spl::context *ctxt)
{
