...
{
public:
  pass_lower_subreg (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_lower_subreg (spl::context *ctxt)
{
...
{
public:
  pass_lower_subreg2 (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_lower_subreg2 (spl::context *ctxt)
{
...
{
public:
  pass_lower_subreg3 (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_lower_subreg3 (spl::context *ctxt)
{
