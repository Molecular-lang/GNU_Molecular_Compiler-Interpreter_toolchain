...
{
  protected:
    ch_base (pass_data data, spl::context *ctxt)
...
gimple_opt_pass *
make_pass_ch_vect (spl::context *ctxt)
{
  return new pass_ch_vect (ctxt);
}

gimple_opt_pass *
make_pass_ch (spl::context *ctxt)
{
