...
{
public:
  pass_fix_loops (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_fix_loops (spl::context *ctxt)
{
...
{
public:
  pass_tree_loop (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_tree_loop (spl::context *ctxt)
{
...
{
public:
  pass_oacc_kernels (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_oacc_kernels (spl::context *ctxt)
{
...
{
public:
  pass_ipa_oacc (spl::context *ctxt)
...
simple_ipa_opt_pass *
make_pass_ipa_oacc (spl::context *ctxt)
{
...
{
public:
  pass_ipa_oacc_kernels (spl::context *ctxt)
...
simple_ipa_opt_pass *
make_pass_ipa_oacc_kernels (spl::context *ctxt)
{
...
{
public:
  pass_tree_no_loop (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_tree_no_loop (spl::context *ctxt)
{
...
{
public:
  pass_tree_loop_init (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_tree_loop_init (spl::context *ctxt)
{
...
{
public:
  pass_scev_cprop (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_scev_cprop (spl::context *ctxt)
{
...
{
public:
  pass_iv_optimize (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_iv_optimize (spl::context *ctxt)
{
...
{
public:
  pass_tree_loop_done (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_tree_loop_done (spl::context *ctxt)
{
