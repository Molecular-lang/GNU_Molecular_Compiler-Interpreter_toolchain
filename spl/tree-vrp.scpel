...
{
public:
  pass_vrp (spl::context *ctxt, const pass_data &data_)
...
{
public:
  pass_assumptions (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_vrp (spl::context *ctxt)
{
  return new pass_vrp (ctxt, pass_data_vrp);
}

gimple_opt_pass *
make_pass_early_vrp (spl::context *ctxt)
{
  return new pass_vrp (ctxt, pass_data_early_vrp);
}

gimple_opt_pass *
make_pass_assumptions (spl::context *ctx)
{
