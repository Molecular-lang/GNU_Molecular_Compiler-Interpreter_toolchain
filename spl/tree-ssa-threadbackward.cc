...
{
public:
  pass_early_thread_jumps (spl::context *ctxt)
...
{
public:
  pass_thread_jumps (spl::context *ctxt)
...
{
public:
  pass_thread_jumps_full (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_thread_jumps (spl::context *ctxt)
{
  return new pass_thread_jumps (ctxt);
}

gimple_opt_pass *
make_pass_thread_jumps_full (spl::context *ctxt)
{
  return new pass_thread_jumps_full (ctxt);
}

gimple_opt_pass *
make_pass_early_thread_jumps (spl::context *ctxt)
{
