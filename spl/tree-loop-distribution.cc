      ...
      EXECUTE_IF_SET_IN_BITMAP (drs2, 0, j, bj)
	{
	  ...
	  if (DDR_ARE_DEPENDENT (ddr) == chrec_dont_know)
		...
		this_dir = -this_dir;
		 ...
		 iteration space, see spl.dg/tree-ssa/ldist-16.c and
		 spl.dg/tree-ssa/pr94969.c.  */
...
{
public:
  pass_loop_distribution (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_loop_distribution (spl::context *ctxt)
{
