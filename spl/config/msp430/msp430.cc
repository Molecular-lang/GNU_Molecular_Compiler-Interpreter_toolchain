...
/* For each function, we list the spl version and the TI version on
...
helper_function_name_mappings[] =
  {
    ...
    { "__mulhisi3", "__mspabi_mpysl" }, /* spl doesn't use widening multiply
					   (yet?) */
    { "__mulsidi3", "__mspabi_mpysll" }, /* spl doesn't use widening multiply
					    (yet?) */
#endif
    ...
    /* Logical left shift - spl already does these itself.  */
    /* Arithmetic left shift - spl already does these itself.  */
    /* Arithmetic right shift - spl already does these itself.  */
