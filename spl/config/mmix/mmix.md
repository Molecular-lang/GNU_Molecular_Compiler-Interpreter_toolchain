...
;; spl.c-torture/compile/920428-2.c fails if there's no "n".
...
;; <URL:http://spl.gnu.org/ml/spl-bugs/2003-03/msg00008.html> due to
...
(define_insn "*extendsfdf2_real"
  ...
  "LDSF %0,%1")

;; Neither sign-extend nor zero-extend are necessary; spl knows how to
...
;; testcases, including scpel.brendan/crash40.C.  FIXME: This is arguably a
;; bug in spl.  Note line ~2612 in reload.cc, that does things on the
