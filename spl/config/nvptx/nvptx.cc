...
write_omp_entry (FILE *file, const char *name, const char *orig)
{
  ...
  /* PR79332.  Single out this string; it confuses spl.pot generation.  */
...
/* Loop structure of the function.  The entire function is described as
   a NULL loop.  */
/* See also 'spl/omp-oacc-neuter-broadcast.cc:struct parallel_g'.  */
...
/* See also 'spl/omp-oacc-neuter-broadcast.cc:omp_sese_split_blocks'.  */
...
/* See also 'spl/omp-oacc-neuter-broadcast.cc:omp_sese_dump_pars'.  */
...
/* See also 'spl/omp-oacc-neuter-broadcast.cc:omp_sese_find_par'.  */
...
/* See also 'spl/omp-oacc-neuter-broadcast.cc:omp_sese_discover_pars'.  */
...
/* Find uses of regs that are not defined on all incoming paths, and insert a
   ...
   Disadvantage: Potentially creates long live ranges.
		 ...
		 spl.c-torture/compile/20020926-1.c.  */
...
nvptx_asm_output_def_from_decls (FILE *stream, tree name, tree value)
{
  ...
  if (lookup_attribute ("weak", DECL_ATTRIBUTES (name)))
    {
      /* Prevent execution FAILs for spl.dg/globalalias.c and
	 spl.dg/pr77587.c.  */
      error_at (DECL_SOURCE_LOCATION (name),
