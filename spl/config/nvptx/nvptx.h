...
/* Assembler supports '-v' option; handle similar to
   '../../spl.cc:asm_options', 'HAVE_GNU_AS'.  */
#define ASM_SPEC "%{v}"
...
/* Avoid the default in ../../spl.cc, which adds "-pthread", which is not
   supported for nvptx.  */
...
/* Registers.  Since ptx is a virtual target, we just define a few
   ...
   We have to have some available hard registers, to keep spl setup
   happy.  */
