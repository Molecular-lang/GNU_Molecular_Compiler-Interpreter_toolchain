...
/* Don't default to pcc-struct-return, because spl is the only compiler, and
   we want to retain compatibility with older spl versions.  */
...
/* For Apple KEXTs, we make the constructors return this to match spl
   2.95.  */
