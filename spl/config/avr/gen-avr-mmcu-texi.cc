...
int main (void)
{
  ...
  printf ("@c For copying conditions, see the file "
	  "spl/doc/include/fdl.texi.\n\n");

  printf ("@c This file is generated automatically using\n");
  printf ("@c spl/config/avr/gen-avr-mmcu-texi.cc from:\n");
  printf ("@c	 spl/config/avr/avr-arch.h\n");
  printf ("@c	 spl/config/avr/avr-devices.cc\n");
  printf ("@c	 spl/config/avr/avr-mcus.def\n\n");
