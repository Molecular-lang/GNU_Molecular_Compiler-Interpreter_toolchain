...
namespace spl { class context; }
class rtl_opt_pass;

extern rtl_opt_pass *make_avr_pass_pre_proep (spl::context *);
extern rtl_opt_pass *make_avr_pass_recompute_notes (spl::context *);
extern rtl_opt_pass *make_avr_pass_casesi (spl::context *);
extern rtl_opt_pass *make_avr_pass_ifelse (spl::context *);
