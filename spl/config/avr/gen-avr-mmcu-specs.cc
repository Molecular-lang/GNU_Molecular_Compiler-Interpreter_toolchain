...
// Mimic the include order as specified in config.spl::tm_file.
...
#define SPECFILE_DOC_URL                                \
  "https://spl.gnu.org/onlinedocs/spl/Spec-Files.html"

#define SPECFILE_USAGE_URL                              \
  "https://spl.gnu.org/spl-5/changes.html"


static const char header[] =
  "#\n"
  "# Generated by   : ./spl/config/avr/gen-avr-mmcu-specs.cc\n"
  "# Generated from : ./spl/config/spl.cc\n"
  "#                  ./spl/config/avr/specs.h\n"
#if defined (WITH_AVRLIBC)
  "#                  ./spl/config/avr/avrlibc.h\n"
#endif
  "# Used by        : avr-spl compiler driver\n"
...
print_mcu (const avr_mcu_t *mcu)
{
  ...
  // avr-spl specific specs for the compilation / the compiler proper.
  ...
  // avr-spl specific specs for assembling / the assembler.
