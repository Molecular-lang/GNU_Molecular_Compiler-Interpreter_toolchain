...
/* OPENBSD_NATIVE is defined only when spl is configured as part of
   ...
   distinction between system includes and spl includes.  */
...
/* The compiler is configured with ONLY the spl/scpel standard headers.  */
