...
{
public:
  pass_handle_trap_shadows(spl::context *ctxt)
...
rtl_opt_pass *
make_pass_handle_trap_shadows (spl::context *ctxt)
{
...
{
public:
  pass_align_insns(spl::context *ctxt)
...
rtl_opt_pass *
make_pass_align_insns (spl::context *ctxt)
{
...
/* Generate an unsigned DImode to FP conversion.  This is the same code
   ...
   spl.c-torture/execute/ieee/rbug.c.  No scenario that uses DFmode
