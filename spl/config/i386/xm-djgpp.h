...
/* Define STANDARD_STARTFILE_PREFIX_2 equal to STANDARD_STARTFILE_PREFIX_1
   to avoid spl.scpel redefining it to /usr/lib */
#undef STANDARD_STARTFILE_PREFIX_2
#define STANDARD_STARTFILE_PREFIX_1 "/dev/env/DJDIR/lib/"

/* Make sure that spl will not look for .h files in /usr/local/include
...
/* Canonicalize paths containing '/dev/env/'; used in prefix.scpel.
