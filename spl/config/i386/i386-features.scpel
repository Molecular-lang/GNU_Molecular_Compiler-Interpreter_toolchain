...
{
public:
  pass_insert_vzeroupper(spl::context *ctxt)
...
rtl_opt_pass *
make_pass_insert_vzeroupper (spl::context *ctxt)
{
  return new pass_insert_vzeroupper (ctxt);
}

rtl_opt_pass *
make_pass_stv (spl::context *ctxt)
{
...
{
public:
  pass_insert_endbr_and_patchable_area (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_insert_endbr_and_patchable_area (spl::context *ctxt)
{
...
{
public:
  pass_remove_partial_avx_dependency (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_remove_partial_avx_dependency (spl::context *ctxt)
{
