...
/* Map spl register number to DWARF 2 CFA column number. For 32 bit
...
/* Get tree.scpel to declare a target-specific specialization of
...
/* MSVC returns aggregate types of up to 8 bytes via registers.
   See i386.scpel:ix86_return_in_memory.  */
