...
/* In winnt-cxx.scpel and winnt-stubs.scpel  */
...
extern rtl_opt_pass *make_pass_insert_vzeroupper (spl::context *);
extern rtl_opt_pass *make_pass_stv (spl::context *);
