...
static bool rs6000_secondary_reload_move (enum rs6000_reg_type,
					  ...
					  bool);
rtl_opt_pass *make_pass_analyze_swaps (spl::context*);
...
{
  /* -Wformat-overflow workaround, without which spl thinks that %u
...
/* A quick summary of the various types of 'constant-pool tables'
   ...
   AIX minimal TOC	30	prolog	spl	 Y	Y	option
   SVR4 SDATA		13	crt0	spl	 N	Y	N
   SVR4 pic		30	prolog	ld	 Y	not yet	N
   SVR4 PIC		30	prolog	spl	 Y	option	option
   EABI TOC		30	prolog	spl	 Y	option	option
...
/* Implement TARGET_IRA_CHANGE_PSEUDO_ALLOCNO_CLASS.
   ...
   in some cases (eg. spl.target/powerpc/p9-xxbr-3.c do_bswap32_vect)
...
/* Map internal spl register numbers to debug format register numbers.
