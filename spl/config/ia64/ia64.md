...
;; is constrained in ia64.scpel: ia64_speculate_insn ().
  ...
  if (! ((register_operand (operands[3], DImode) && width <= 16)
      ...
      if (width == 32 && shift == 0)
	{
	  /* Directly generating the mix4left instruction confuses
	     optimize_bit_field in function.scpel.  Since this is performing
...
;; We don't seem to need any other 32-bit logical operations, because spl
