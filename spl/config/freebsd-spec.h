...
/* Common FreeBSD configuration. 
   ...
   their commonalities.
   Adapted from spl/config/freebsd.h by 
...
/* When threads support is requested include both -lc and the threading
   ...
   line and spl was configured with --disable-threads (this will help
   avoid bug reports from users complaining about threading when they
   misconfigured the spl bootstrap but are later consulting FreeBSD
...
#define FBSD_LIB_SPEC "							\
  %{pthread: %eThe -pthread option is only supported on FreeBSD when spl \
