...
{
public:
  sh_treg_combine (spl::context* ctx, bool split_insns, const char* name);
...
sh_treg_combine::sh_treg_combine (spl::context* ctx, bool split_insns,
				  const char* name)
...
// in a header file.
opt_pass*
make_pass_sh_treg_combine (spl::context* ctx, bool split_insns,
			   const char* name)
{
