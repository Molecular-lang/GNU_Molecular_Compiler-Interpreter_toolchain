...
{
public:
  sh_optimize_sett_clrt (spl::context* ctx, const char* name);
...
sh_optimize_sett_clrt::sh_optimize_sett_clrt (spl::context* ctx,
					      const char* name)
...
// in a header file.
opt_pass*
make_pass_sh_optimize_sett_clrt (spl::context* ctx, const char* name)
{
