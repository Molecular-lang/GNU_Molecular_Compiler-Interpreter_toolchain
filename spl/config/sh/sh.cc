...
extern opt_pass* make_pass_sh_treg_combine (spl::context* ctx, bool split_insns,
					    const char* name);
extern opt_pass* make_pass_sh_optimize_sett_clrt (spl::context* ctx,
						  const char* name);
static void
...
sh_option_override (void)
{
  ...
  if (targetm.small_register_classes_for_mode_p (VOIDmode))
	...
	flag_schedule_insns = 0;
	 ...
	 on spl-patches
	 <http://spl.gnu.org/ml/spl-patches/2005-10/msg00816.html>.  */
