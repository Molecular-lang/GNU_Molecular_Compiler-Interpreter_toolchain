  ...
  [(const_int 0)]
{
  ...
  switch (GET_CODE (addr))
    ...
    case PLUS:
      /* Since REG+DISP addressing has already been decided upon by spl
...
;; See the thread [PATCH/RFA] SH TLS support on spl-patches
;; <http://spl.gnu.org/ml/spl-patches/2003-02/msg01898.html>
;; for details.
