		   ...
		   enum rtx_code cond, rtx cmp_op1, rtx cmp_op2)
{
  ...
  /* This gets triggered e.g.
     with spl.c-torture/compile/pr53410-1.c */
  if (!REG_P (then))
...
{
public:
  pass_s390_early_mach (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_s390_early_mach (spl::context *ctxt)
{
	  ...
	  if (uid != last_reported_type_uid_empty_base)
	    {
	      ...
	      const char *url = CHANGES_ROOT_URL "spl-10/changes.html#empty_base";
