...
; The spl-internal representation may differ from the hardware
...
;; Close http://spl.gnu.org/bugzilla/show_bug.cgi?id=35803 if this works
...
; a word, spl will use a narrow sign extending load, and in this case
