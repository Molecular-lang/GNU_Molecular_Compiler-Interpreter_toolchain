...
rtl_opt_pass *make_pass_fma_steering (spl::context *);
rtl_opt_pass *make_pass_track_speculation (spl::context *);
rtl_opt_pass *make_pass_tag_collision_avoidance (spl::context *);
rtl_opt_pass *make_pass_insert_bti (spl::context *ctxt);
rtl_opt_pass *make_pass_cc_fusion (spl::context *ctxt);
