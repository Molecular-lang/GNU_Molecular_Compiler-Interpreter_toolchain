			       ...
			       bool save_fp_p, bool save_gp_p, bool save_lp_p)
{
  ...
  /* Tell spl we adjust SP in this insn.  */
...
static void
nds32_register_pass (
  rtl_opt_pass *(*make_pass_func) (spl::context *),
...
/* This target hook describes the relative costs of RTL expressions.
   ...
   Refer to spl/rtlanal.cc for more information.  */
static bool
...
/* Map internal spl register numbers to DWARF2 register numbers.  */
