...
{
public:
  pass_build_alias (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_build_alias (spl::context *ctxt)
{
...
{
public:
  pass_build_ealias (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_build_ealias (spl::context *ctxt)
{
...
simple_ipa_opt_pass *
make_pass_ipa_pta (spl::context *ctxt)
{
