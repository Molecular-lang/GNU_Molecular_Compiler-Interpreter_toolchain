...
{
public:
  pass_df_initialize_opt (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_df_initialize_opt (spl::context *ctxt)
{
...
{
public:
  pass_df_initialize_no_opt (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_df_initialize_no_opt (spl::context *ctxt)
{
...
{
public:
  pass_df_finish (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_df_finish (spl::context *ctxt)
{
