...
{
public:
  pass_oacc_loop_designation (spl::context *ctxt)
...
{
public:
  pass_oacc_device_lower (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_oacc_loop_designation (spl::context *ctxt)
{
  return new pass_oacc_loop_designation (ctxt);
}

gimple_opt_pass *
make_pass_oacc_device_lower (spl::context *ctxt)
{
...
{
public:
  pass_omp_device_lower (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_omp_device_lower (spl::context *ctxt)
{
...
{
public:
  pass_omp_target_link (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_omp_target_link (spl::context *ctxt)
{
