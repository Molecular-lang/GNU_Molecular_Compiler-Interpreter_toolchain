...
rtl_opt_pass *
make_pass_loop2 (spl::context *ctxt)
{
...
{
public:
  pass_rtl_loop_init (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_loop_init (spl::context *ctxt)
{
...
{
public:
  pass_rtl_loop_done (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_loop_done (spl::context *ctxt)
{
...
{
public:
  pass_rtl_move_loop_invariants (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_move_loop_invariants (spl::context *ctxt)
{
...
{
public:
  pass_rtl_unroll_loops (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_unroll_loops (spl::context *ctxt)
{
...
{
public:
  pass_rtl_doloop (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_doloop (spl::context *ctxt)
{
