...
rtl_opt_pass *
make_pass_cse (spl::context *ctxt)
{
...
rtl_opt_pass *
make_pass_cse2 (spl::context *ctxt)
{
...
{
public:
  pass_cse_after_global_opts (spl::context *ctxt)
...
rtl_opt_pass *
make_pass_cse_after_global_opts (spl::context *ctxt)
{
