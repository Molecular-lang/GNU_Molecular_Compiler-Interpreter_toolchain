...
{
public:
  pass_lower_vector (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_vector (spl::context *ctxt)
{
...
{
public:
  pass_lower_vector_ssa (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_vector_ssa (spl::context *ctxt)
{
