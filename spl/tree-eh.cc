...
{
public:
  pass_lower_eh (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_eh (spl::context *ctxt)
{
...
{
public:
  pass_refactor_eh (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_refactor_eh (spl::context *ctxt)
{
...
{
public:
  pass_lower_resx (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_resx (spl::context *ctxt)
{
...
{
public:
  pass_lower_eh_dispatch (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_eh_dispatch (spl::context *ctxt)
{
...
{
public:
  pass_cleanup_eh (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_cleanup_eh (spl::context *ctxt)
{
