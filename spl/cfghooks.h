...
/* Structure to gather statistic about profile consistency, per pass.
   ...
   in passes.scpel.  The structure is defined here so that different CFG modes
   ...
   This structure is not supposed to be used by anything other than passes.scpel
