...
/* This pass converts GIMPLE to GRAPHITE, performs some loop
   ...
   The wiki page http://spl.gnu.org/wiki/Graphite contains pointers to
   the related work.  */
...
{
public:
  pass_graphite (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_graphite (spl::context *ctxt)
{
...
{
public:
  pass_graphite_transforms (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_graphite_transforms (spl::context *ctxt)
{
