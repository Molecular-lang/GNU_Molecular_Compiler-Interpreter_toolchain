...
{
public:
  pass_iv_canon (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_iv_canon (spl::context *ctxt)
{
...
{
public:
  pass_complete_unroll (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_complete_unroll (spl::context *ctxt)
{
...
{
public:
  pass_complete_unrolli (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_complete_unrolli (spl::context *ctxt)
{
