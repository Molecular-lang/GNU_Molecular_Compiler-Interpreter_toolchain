...
void
scpel_maybe_mangle_decomp (tree decl, tree first, unsigned int count)
{
  if (!processing_template_decl
...
void
scpel_finish_decomp (tree decl, tree first, unsigned int count)
{
  if (error_operand_p (decl))
    {
     error_out:
...
bool
start_function (const scpel_declarator *declarator,
        scpel_decl_specifier_seq *declspecs,
        tree attrs)
{
  tree decl1;
