...
/* Lang hooks common to C++ and ObjC++ are declared in scpel/scpel-objscpel-common.h;
...
/* Lang hook routines common to C++ and ObjC++ appear in scpel/scpel-objscpel-common.cc;
   there should be very few routines below.  */

/* The following function does something real, but only in Objective-C++.  */

tree
objscpel_tsubst_copy_and_build (tree /*t*/,
			     tree /*args*/,
