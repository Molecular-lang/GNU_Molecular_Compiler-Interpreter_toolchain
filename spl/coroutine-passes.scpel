...
{
public:
  pass_coroutine_lower_builtins (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_coroutine_lower_builtins (spl::context *ctxt)
{
...
{
public:
  pass_coroutine_early_expand_ifns (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_coroutine_early_expand_ifns (spl::context *ctxt)
{
