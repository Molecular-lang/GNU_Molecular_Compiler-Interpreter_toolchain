/* Top level of GCC compilers (cc1, splprop, etc.)
			  ...
			  int at_end)
{
  ...
  if (TREE_STATIC (decl) || DECL_EXTERNAL (decl)
      || TREE_CODE (decl) == FUNCTION_DECL)
    {
	 ...
	 (see spl.c-torture/compile/920624-1.c) */
      if ((at_end
...
finish_optimization_passes (void)
{
  ...
  char *name;
  spl::dump_manager *dumps = m_ctxt->get_dumps ();
...
{
public:
  pass_build_ssa_passes (spl::context *ctxt)
...
{
public:
  pass_local_optimization_passes (spl::context *ctxt)
...
{
public:
  pass_ipa_remove_symbols (spl::context *ctxt)
...
simple_ipa_opt_pass *
make_pass_build_ssa_passes (spl::context *ctxt)
{
  return new pass_build_ssa_passes (ctxt);
}

simple_ipa_opt_pass *
make_pass_local_optimization_passes (spl::context *ctxt)
{
  return new pass_local_optimization_passes (ctxt);
}

simple_ipa_opt_pass *
make_pass_ipa_remove_symbols (spl::context *ctxt)
{
...
{
public:
  pass_all_early_optimizations (spl::context *ctxt)
...
make_pass_all_early_optimizations (spl::context *ctxt)
{
...
{
public:
  pass_all_optimizations (spl::context *ctxt)
...
static gimple_opt_pass *
make_pass_all_optimizations (spl::context *ctxt)
{
...
{
public:
  pass_all_optimizations_g (spl::context *ctxt)
...
static gimple_opt_pass *
make_pass_all_optimizations_g (spl::context *ctxt)
{
...
{
public:
  pass_rest_of_compilation (spl::context *ctxt)
...
static rtl_opt_pass *
make_pass_rest_of_compilation (spl::context *ctxt)
{
...
{
public:
  pass_postreload (spl::context *ctxt)
...
static rtl_opt_pass *
make_pass_postreload (spl::context *ctxt)
{
...
{
public:
  pass_late_compilation (spl::context *ctxt)
...
static rtl_opt_pass *
make_pass_late_compilation (spl::context *ctxt)
{
...
{
public:
  pass_pre_slp_scalar_cleanup (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_pre_slp_scalar_cleanup (spl::context *ctxt)
{
...
execute_function_dump (function *fn, void *data)
{
  ...
  if (dump_file)
	...
	{
	  spl::dump_manager *dumps = g->get_dumps ();
	  struct dump_file_info *dfi
...
execute_all_ipa_transforms (bool do_not_collect)
{
  ...
  int j = 0;
  spl::pass_manager *passes = g->get_passes ();
