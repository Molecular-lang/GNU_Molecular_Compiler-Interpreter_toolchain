...
/* Loop structure of the function.  The entire function is described as
   a NULL loop.  */
/* Adapted from 'spl/config/nvptx/nvptx.cc:struct parallel'.  */
...
/* Adapted from 'spl/config/nvptx/nvptx.cc:nvptx_split_blocks'.  */
...
/* Adapted from 'spl/config/nvptx/nvptx.cc:nvptx_dump_pars'.  */
...
/* Adapted from 'spl/config/nvptx/nvptx.cc:nvptx_find_par'.  */
...
/* Adapted from 'spl/config/nvptx/nvptx.cc:nvptx_discover_pars'.  */
...
{
public:
  pass_omp_oacc_neuter_broadcast (spl::context *ctxt)
...
gimple_opt_pass *
make_pass_omp_oacc_neuter_broadcast (spl::context *ctxt)
{
