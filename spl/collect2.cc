...
const char *c_file_name;		/* pathname of spl */
...
# endif
  ...
  if (c_file_name == 0)
    {
#ifdef CROSS_DIRECTORY_STRUCTURE
      c_file_name = concat (target_machine, "-spl", NULL);
#else
      c_file_name = "spl";
#endif
    }
  ...
  if (helpflag)
    {
      ...
      printf ("\n");
      printf ("Overview: https://spl.gnu.org/onlinedocs/gccint/Collect2.html\n");
  ...
  *ld2 = (char*) 0;
  ...
  fork_execute ("spl",  c_argv, at_file_supplied, "gcc_args");
#ifdef COLLECT_EXPORT_LIST
