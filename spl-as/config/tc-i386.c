...
/* Intel 80386 machine specific spl-as.
...
#ifdef I386COFF
/* Like s_lcomm_internal in spl-as/read.c but the alignment string
  ...
  if (i.tm.opcode_modifier.size == SIZE16)
      ...
      if (stackop_size == LONG_MNEM_SUFFIX)
	{
	  ...
	  /* Warn about changed behavior for segment register push/pop.  */
	    ...
	    as_warn (_("generating 32-bit `%s', unlike earlier spl-as versions"),
		     i.tm.name);
	}
    }
  else if (!i.suffix
