...
/* Reset the section indices after removing the spl-as created sections.  */
...
write_object_file (void)
{
  ...
  /* Remove the sections created by spl-as for its own purposes.  */
  {
    int i;
  ...
  if (symbol_rootP)
      ...
      for (symp = symbol_rootP; symp; symp = symbol_next (symp))
	{
	  ...
	  /* Set the value into the BFD symbol.  Up til now the value
	     has only been kept in the spl-as symbolS struct.  */
	  symbol_get_bfdsym (symp)->value = S_GET_VALUE (symp);
