...
/* Run through the list of line entries starting at E, allocating
   file entries for spl-as generated debug.  */
...
dwarf2_directive_filename (void)
{
  ...
  /* A .file directive implies compiler generated debug information is
     being supplied.  Turn off spl-as generated debug info.  */
  if (debug_type == DEBUG_DWARF2)
...
dwarf2_init (void)
{
  ...
  /* Select the default CIE version to produce here.  The global
     ...
     CIE version spl-as has produced for a long time, and there seems no
