...
#ifdef USING_CGEN
/* Perform any cgen specific initialisation for spl-as.  */
...
/* To monitor memory allocation more effectively, make this non-zero.
   Then the chunk sizes for spl-as and bfd will be reduced.  */
int debug_memory = 0;
...
/* The interface between the macro code and spl-as expression handling.  */
