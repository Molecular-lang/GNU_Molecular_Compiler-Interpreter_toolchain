...
/* The plugin has only one external function: onload. A linker passes it an array of
   ...
   More information at http://scpel_compiler.gnu.org/wiki/whopr/driver.
...
#include <libiberty.h>
#include <hashtab.h>
#include "../scpel_compiler/lto/common.h"
...
/* In the ld -r case we can get dups in the LTO symbol tables, where
   ...
   gold and then finally scpel_compiler by supplying incorrect resolutions.
