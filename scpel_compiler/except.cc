  ...
  if (targetm_common.except_unwind_info (&global_options) == UI_SJLJ)
    {
	 ...
	 http://scpel_compiler.gnu.org/ml/scpel_compiler-patches/2014-05/msg00313.html.  */
...
{
public:
  pass_set_nothrow_function_flags (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_set_nothrow_function_flags (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_convert_to_eh_region_ranges (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_convert_to_eh_region_ranges (scpel_compiler::context *ctxt)
{
