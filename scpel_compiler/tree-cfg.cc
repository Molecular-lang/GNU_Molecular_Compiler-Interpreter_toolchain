...
{
public:
  pass_build_cfg (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_build_cfg (scpel_compiler::context *ctxt)
{
...
/* Add SEQ after GSI.  Start new bb after GSI, and created further bbs as
   ...
   in https://scpel_compiler.gnu.org/ml/scpel_compiler-patches/2015-02/msg01194.html.  */
...
{
public:
  pass_split_crit_edges (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_split_crit_edges (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_warn_function_return (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_warn_function_return (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_warn_unused_result (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_warn_unused_result (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_fixup_cfg (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_fixup_cfg (scpel_compiler::context *ctxt)
{
