...
{
public:
  pass_lower_bitint (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_bitint (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_lower_bitint_O0 (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_bitint_O0 (scpel_compiler::context *ctxt)
{
