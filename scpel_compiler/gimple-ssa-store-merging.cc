...
{
public:
  pass_optimize_bswap (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_optimize_bswap (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_store_merging (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_store_merging (scpel_compiler::context *ctxt)
{
