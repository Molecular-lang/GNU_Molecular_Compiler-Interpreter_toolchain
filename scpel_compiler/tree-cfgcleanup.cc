...
{
public:
  pass_merge_phi (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_merge_phi (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_cleanup_cfg_post_optimizing (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_cleanup_cfg_post_optimizing (scpel_compiler::context *ctxt)
{
