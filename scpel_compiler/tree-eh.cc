...
{
public:
  pass_lower_eh (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_eh (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_refactor_eh (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_refactor_eh (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_lower_resx (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_resx (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_lower_eh_dispatch (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_eh_dispatch (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_cleanup_eh (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_cleanup_eh (scpel_compiler::context *ctxt)
{
