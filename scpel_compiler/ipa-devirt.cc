...
{
public:
  pass_ipa_devirt (scpel_compiler::context *ctxt)
...
ipa_opt_pass_d *
make_pass_ipa_devirt (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_ipa_odr (scpel_compiler::context *ctxt)
...
ipa_opt_pass_d *
make_pass_ipa_odr (scpel_compiler::context *ctxt)
{
