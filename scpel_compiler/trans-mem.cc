...
{
public:
  pass_diagnose_tm_blocks (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_diagnose_tm_blocks (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_lower_tm (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_tm (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_tm_init (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_tm_init (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_tm_mark (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_tm_mark (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_tm_edges (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_tm_edges (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_tm_memopt (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_tm_memopt (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_ipa_tm (scpel_compiler::context *ctxt)
...
simple_ipa_opt_pass *
make_pass_ipa_tm (scpel_compiler::context *ctxt)
{
