...
{
public:
  pass_tsan (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_tsan (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_tsan_O0 (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_tsan_O0 (scpel_compiler::context *ctxt)
{
