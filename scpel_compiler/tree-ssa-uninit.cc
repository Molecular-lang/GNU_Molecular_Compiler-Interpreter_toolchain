  ...
  if (wlims.always_executed)
		      ...
		      "%qE is used uninitialized", rhs))
	{
	  /* ???  This is only effective for decls as in
	     scpel_compiler.dg/uninit-B-O0.c.  Avoid doing this for maybe-uninit
...
{
public:
  pass_late_warn_uninitialized (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_late_warn_uninitialized (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_early_warn_uninitialized (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_early_warn_uninitialized (scpel_compiler::context *ctxt)
{
