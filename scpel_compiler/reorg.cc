...
static bool
stop_search_p (rtx_insn *insn, bool labels_p)
{
  if (insn == 0)
    return true;
...
{
public:
  pass_delay_slots (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_delay_slots (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_machine_reorg (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_machine_reorg (scpel_compiler::context *ctxt)
{
