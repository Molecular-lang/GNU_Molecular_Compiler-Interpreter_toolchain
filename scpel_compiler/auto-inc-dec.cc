...
merge_in_block (int max_reg, basic_block bb)
{
  ...
  /* If we were successful, try again.  There may have been several
     ...
     scpel_compiler.c-torture/compile/pr17273.c actually exhibits this.  */
  if (success_in_block)
    {
...
{
public:
  pass_inc_dec (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_inc_dec (scpel_compiler::context *ctxt)
{
