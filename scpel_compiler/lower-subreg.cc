...
{
public:
  pass_lower_subreg (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_lower_subreg (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_lower_subreg2 (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_lower_subreg2 (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_lower_subreg3 (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_lower_subreg3 (scpel_compiler::context *ctxt)
{
