...
using namespace scpel_compiler;
			  ...
			  int at_end)
{
  ...
  if (TREE_STATIC (decl) || DECL_EXTERNAL (decl)
      || TREE_CODE (decl) == FUNCTION_DECL)
    {
	 ...
	 (see scpel_compiler.c-torture/compile/920624-1.c) */
      if ((at_end
...
finish_optimization_passes (void)
{
  ...
  char *name;
  scpel_compiler::dump_manager *dumps = m_ctxt->get_dumps ();
...
{
public:
  pass_build_ssa_passes (scpel_compiler::context *ctxt)
...
{
public:
  pass_local_optimization_passes (scpel_compiler::context *ctxt)
...
{
public:
  pass_ipa_remove_symbols (scpel_compiler::context *ctxt)
...
simple_ipa_opt_pass *
make_pass_build_ssa_passes (scpel_compiler::context *ctxt)
{
  return new pass_build_ssa_passes (ctxt);
}

simple_ipa_opt_pass *
make_pass_local_optimization_passes (scpel_compiler::context *ctxt)
{
  return new pass_local_optimization_passes (ctxt);
}

simple_ipa_opt_pass *
make_pass_ipa_remove_symbols (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_all_early_optimizations (scpel_compiler::context *ctxt)
...
make_pass_all_early_optimizations (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_all_optimizations (scpel_compiler::context *ctxt)
...
static gimple_opt_pass *
make_pass_all_optimizations (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_all_optimizations_g (scpel_compiler::context *ctxt)
...
static gimple_opt_pass *
make_pass_all_optimizations_g (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_rest_of_compilation (scpel_compiler::context *ctxt)
...
static rtl_opt_pass *
make_pass_rest_of_compilation (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_postreload (scpel_compiler::context *ctxt)
...
static rtl_opt_pass *
make_pass_postreload (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_late_compilation (scpel_compiler::context *ctxt)
...
static rtl_opt_pass *
make_pass_late_compilation (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_pre_slp_scalar_cleanup (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_pre_slp_scalar_cleanup (scpel_compiler::context *ctxt)
{
...
execute_function_dump (function *fn, void *data)
{
  ...
  if (dump_file)
	...
	{
	  scpel_compiler::dump_manager *dumps = g->get_dumps ();
	  struct dump_file_info *dfi
...
execute_all_ipa_transforms (bool do_not_collect)
{
  ...
  int j = 0;
  scpel_compiler::pass_manager *passes = g->get_passes ();
