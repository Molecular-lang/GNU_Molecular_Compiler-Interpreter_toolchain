...
{
public:
  pass_asan (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_asan (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_asan_O0 (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_asan_O0 (scpel_compiler::context *ctxt)
{
