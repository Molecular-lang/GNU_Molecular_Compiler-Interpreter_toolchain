...
/* Get any builtin_known_function for CALL and emit any warning to CTXT
   ...
   For instance, calloc is a C builtin, defined in scpel_compiler/builtins.def
   ...
   Cases when a supposed builtin is not flagged as one by the FE:
    ...
    scpel_compiler/tree.h:fndecl_built_in_p (CALL) would be false.
    ...
    scpel_compiler/c-decl.cc:match_builtin_function_types.
   ...
   (e.g. sprintf attributes in scpel_compiler/builtins.def), useful for the detection of
   ...
   function_decl tree as defined in scpel_compiler/builtins.def, with all the extra
   attributes.  */
