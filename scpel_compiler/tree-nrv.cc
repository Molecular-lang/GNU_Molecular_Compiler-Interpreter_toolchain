...
{
public:
  pass_nrv (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_nrv (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_return_slot (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_return_slot (scpel_compiler::context *ctxt)
{
