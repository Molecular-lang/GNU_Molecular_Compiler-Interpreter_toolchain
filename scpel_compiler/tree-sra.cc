  ...
  if (access->grp_to_be_replaced)
    {
	 ...
	 like in scpel_compiler.c-torture/execute/20041124-1.c, 20050316-1.c and
	 scpel_compiler.c-torture/compile/20011217-1.c.
...
{
public:
  pass_sra_early (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_sra_early (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_sra (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_sra (scpel_compiler::context *ctxt)
{
