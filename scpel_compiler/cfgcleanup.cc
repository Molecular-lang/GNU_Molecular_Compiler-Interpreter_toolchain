...
{
public:
  pass_jump (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_jump (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_jump_after_combine (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_jump_after_combine (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_jump2 (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_jump2 (scpel_compiler::context *ctxt)
{
