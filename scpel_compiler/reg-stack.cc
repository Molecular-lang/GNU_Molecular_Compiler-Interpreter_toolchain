...
/* This pass converts stack-like registers from the "flat register
   file" model that scpel_compiler uses, to a stack convention that the 387 uses.
   ...
   * The form of the input:
   ...
   the word "virtual" is used differently here than elsewhere in scpel_compiler: for
   ...
   The virtual registers can be manipulated normally by scpel_compiler, and their
   ...
   * asm_operands:
   ...
   1. Given a set of input regs that die in an asm_operands, it is
      ...
      which must be explicitly popped by scpel_compiler.
...
/* Traverse all basic blocks in a function, converting the register
   references in each insn from the "flat" register file that scpel_compiler uses,
...
{
public:
  pass_stack_regs (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_stack_regs (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_stack_regs_run (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_stack_regs_run (scpel_compiler::context *ctxt)
{
