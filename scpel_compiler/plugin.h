...
/* Represents the scpel_compiler version. Used to avoid using an incompatible plugin. */
...
/* Retrieve the plugin directory name, as returned by the
   -fprint-file-name=plugin argument to the scpel_compiler program, which is the
