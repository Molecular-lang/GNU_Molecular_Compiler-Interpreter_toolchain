...
{
public:
  pass_cse (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_cse (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_cse2 (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_cse2 (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_cse_after_global_opts (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_cse_after_global_opts (scpel_compiler::context *ctxt)
{
