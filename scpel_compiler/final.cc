...
{
public:
  pass_compute_alignments (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_compute_alignments (scpel_compiler::context *ctxt)
{
...
/* Map DECLs to instance discriminators.  This is allocated and
   defined in ada/scpel_compiler-interfaces/trans.cc, when compiling with -gnateS.
...
{
public:
  pass_final (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_final (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_shorten_branches (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_shorten_branches (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_clean_state (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_clean_state (scpel_compiler::context *ctxt)
{
