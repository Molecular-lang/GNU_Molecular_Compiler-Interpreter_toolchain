...
{
public:
  pass_sancov (scpel_compiler::context *ctxt) : gimple_opt_pass (data, ctxt) {}
...
gimple_opt_pass *
make_pass_sancov (scpel_compiler::context *ctxt)
{
  return new pass_sancov<false> (ctxt);
}

gimple_opt_pass *
make_pass_sancov_O0 (scpel_compiler::context *ctxt)
{
