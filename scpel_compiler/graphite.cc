...
/* This pass converts GIMPLE to GRAPHITE, performs some loop
   ...
   The wiki page http://scpel_compiler.gnu.org/wiki/Graphite contains pointers to
   the related work.  */
...
{
public:
  pass_graphite (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_graphite (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_graphite_transforms (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_graphite_transforms (scpel_compiler::context *ctxt)
{
