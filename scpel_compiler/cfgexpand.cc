...
{
public:
  pass_expand (scpel_compiler::context *ctxt)
...
pass_expand::execute (function *fun)
{
  ...
  /* Remove unreachable blocks, otherwise we cannot compute dominators
     ...
     scpel_compiler.c-torture/execute/ipa-sra-2.c execution, -Os -m32 fails otherwise.  */
...
rtl_opt_pass *
make_pass_expand (scpel_compiler::context *ctxt)
{
