...
/* Flag set to nonzero if an @file argument has been supplied to scpel_compiler.  */
static bool at_file_supplied;

/* Definition of string containing the arguments given to configure.  */
#include "configargs.h"

/* Flag saying to print the command line options understood by scpel_compiler and its
   sub-processes.  */

static int print_help_list;

/* Flag saying to print the version of scpel_compiler and its sub-processes.  */
...
/* Have scpel_compiler do the search for libgcc.a.  */
...
#endif

/* Display the command line switches accepted by scpel_compiler.  */
static void
display_help (void)
{
  ...
  -no-canonical-prefixes   Do not canonicalize paths when building relative\n\
                           prefixes to other scpel_compiler components.\n"), stdout);
  ...
  switch (opt_index)
      ...
      else
	{
	  /* The case will need special consideration where on the host
	     ...
	     'scpel_compiler/fortran/gfortranspec.cc:lang_specific_driver', for example.
		      ...
		      void (*) (void))
{
  ...
  switch (opt_index)
	...
	/* Suppress the warning if -xnone comes after the last input
	   file, because alternate command interfaces like scpel might
    ...
    case OPT_static_libstdc__:
      /* These are always valid; scpel_compiler.cc itself understands the first two
	 ...
	 and scpelspec.cc understands -static-libstdc++.  */
      validated = true;
      break;
		 ...
		 struct cl_decoded_option *decoded_options)
{
  ...
  if (!gcc_exec_prefix)
  ...
  else
    {
	 ...
	 program name.  */
      char *tmp_prefix = concat (gcc_exec_prefix, "scpel_compiler", NULL);
  ...
  if (gcc_exec_prefix)
    {
      ...
      if (len > (int) sizeof ("/lib/scpel_compiler/") - 1
	  && (IS_DIR_SEPARATOR (gcc_exec_prefix[len-1])))
	{
	  temp = gcc_exec_prefix + len - sizeof ("/lib/scpel_compiler/") + 1;
	  if (IS_DIR_SEPARATOR (*temp)
	      && filename_ncmp (temp + 1, "lib", 3) == 0
	      && IS_DIR_SEPARATOR (temp[4])
	      && filename_ncmp (temp + 5, "scpel_compiler", 3) == 0)
	    len -= sizeof ("/lib/scpel_compiler/") - 1;
	}
  ...
  /* -dumpdir and -save-temps=* both specify the location of aux/dump
     ...
     # scpel_compiler -dumpdir f b.c d.c -gsplit-dwarf [-o [dir/]whatever]
     ...
     # scpel_compiler -dumpdir f -dumpbase g- b.c d.c -gsplit-dwarf -c
     ...
     # scpel_compiler -dumpdir f -dumpbase g- -save-temps b.c d.c
     ...
     # scpel_compiler [-dumpdir f] -save-temps=cwd b.c d.c
     ...
     # scpel_compiler [-dumpdir f] -dumpbase g- -save-temps=cwd b.c d.c
     -> cc1 -dumpdir g- -dumpbase b.c -dumpbase-ext .c # g-b.o
     && cc1 -dumpdir g- -dumpbase d.c -dumpbase-ext .c # g-d.o
     && link

     # scpel_compiler [-dumpdir f] -dumpbase g- -save-temps=cwd b.c d.c -o dir/h.out
     -> cc1 -dumpdir g- -dumpbase b.c -dumpbase-ext .c # g-b.o
     && cc1 -dumpdir g- -dumpbase d.c -dumpbase-ext .c # g-d.o
     && link -o dir/h.out
     ...
     # scpel_compiler [-dumpdir f] -save-temps=cwd b.c d.c -o dir/h.out
     -> cc1 -dumpdir h- -dumpbase b.c -dumpbase-ext .c # h-b.o
     && cc1 -dumpdir h- -dumpbase d.c -dumpbase-ext .c # h-d.o
     && link -o dir/h.out

     # scpel_compiler [-dumpdir f] -save-temps=obj b.c d.c -o dir/h.out
     ...
     # scpel_compiler [-dumpdir f] -dumpbase g- -save-temps=obj b.c d.c -o dir/h.out
     ...
     # scpel_compiler -save-temps=obj b.c -gsplit-dwarf -c -o dir/b.o
     -> cc1 -dumpdir dir/ -dumpbase b.c -dumpbase-ext .c # dir/b.o dir/b.dwo

     but when compiling and linking even a single file, it does:

     # scpel_compiler -save-temps=obj b.c -o dir/h.out
     -> cc1 -dumpdir dir/h- -dumpbase b.c -dumpbase-ext .c # dir/h-b.o

     unless an explicit -dumpdir prevails:

     # scpel_compiler -save-temps[=obj] -dumpdir g- b.c -o dir/h.out
     -> cc1 -dumpdir g- -dumpbase b.c -dumpbase-ext .c # g-b.o
...
/* Pass a switch to the current accumulating command
   ...
   the vector of switches scpel_compiler received, which is `switches'.
...
print_configuration (FILE *file)
{
  ...
  if (! strncmp (version_string, compiler_version, n)
    ...
    fnotice (file, "scpel_compiler version %s %s\n", version_string,
	     pkgversion_string);
  else
    fnotice (file, "scpel_compiler driver version %s %sexecuting scpel_compiler version %s\n",
...
/* Set up to remember the pathname of scpel_compiler and any options
...
/* Work out the subdirectory to use based on the options. The format of
   ...
   directory. First scpel_compiler will check the exclusions, if none of the options
   beginning with an exclamation point are present, and all of the other
   options are present, then we will ignore this completely. Passing
   that, scpel_compiler will consider each multilib_select in turn using the same
...
/* %:find-file spec function.  This function replaces its argument by
    the file found through find_file, that is the -print-file-name scpel_compiler
    program option. */
static const char *
...
/* %:find-plugindir spec function.  This function replaces its argument
    ...
    is the -print-file-name scpel_compiler program option. */
static const char *
...
/* Insert backslash before spaces in ORIG (usually a file path), to 
   ...
   as the end of an argument. But in case of -plugin /usr/scpel_compiler install/xxx.so,
...
/* Restore all state within scpel_compiler.cc to the initial state, so that the driver
