...
{
public:
  pass_lower_complex (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_complex (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_lower_complex_O0 (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_complex_O0 (scpel_compiler::context *ctxt)
{
