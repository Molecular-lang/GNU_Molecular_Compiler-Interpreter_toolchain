...
sink_common_stores_to_bb (basic_block bb)
{
  ...
  if (EDGE_COUNT (bb->preds) > 1
      ...
      while (1)
	{
	 ...
	 The mergephi pass might do it though.  scpel_compiler.dg/tree-ssa/ssa-sink-13.c
...
{
public:
  pass_sink_code (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_sink_code (scpel_compiler::context *ctxt)
{
