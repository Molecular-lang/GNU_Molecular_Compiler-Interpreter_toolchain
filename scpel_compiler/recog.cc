...
{
public:
  pass_peephole2 (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_peephole2 (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_split_all_insns (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_split_all_insns (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_split_after_reload (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_split_after_reload (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_split_before_sched2 (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_split_before_sched2 (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_split_before_regstack (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_split_before_regstack (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_split_for_shorten_branches (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_split_for_shorten_branches (scpel_compiler::context *ctxt)
{
