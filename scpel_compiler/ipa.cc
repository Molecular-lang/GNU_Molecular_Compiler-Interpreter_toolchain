  ...
  FOR_EACH_VARIABLE (vnode)
	...
	if (!address_taken && !written
	    /* Making variable in explicit section readonly can cause section
	       type conflict. 
	       See e.g. scpel_compiler.c-torture/compile/pr23237.c */
...
{
public:
  pass_ipa_cdtor_merge (scpel_compiler::context *ctxt)
...
ipa_opt_pass_d *
make_pass_ipa_cdtor_merge (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_ipa_single_use (scpel_compiler::context *ctxt)
...
ipa_opt_pass_d *
make_pass_ipa_single_use (scpel_compiler::context *ctxt)
{
