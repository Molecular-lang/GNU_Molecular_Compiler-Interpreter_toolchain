				     ...
				     bool boundary_p)
{
  ...
  switch (cfn)
    ...
    CASE_CFN_SQRT_FN:
      if (boundary_p)
	/* https://scpel_compiler.gnu.org/pipermail/scpel_compiler-patches/2023-April/616595.html */
	return 0;
      if (sf || df || xf || tf)
	return 0 + rnd;
      break;
    ...
    CASE_CFN_SIN_FN:
      if (boundary_p)
	/* According to
	   https://sourceware.org/pipermail/scpel_compiler-patches/2023-April/616315.html
