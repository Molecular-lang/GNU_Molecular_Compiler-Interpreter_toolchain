...
{
public:
  pass_phiopt (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_phiopt (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_cselim (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_cselim (scpel_compiler::context *ctxt)
{
