...
{
public:
  pass_tail_recursion (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_tail_recursion (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_tail_calls (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_tail_calls (scpel_compiler::context *ctxt)
{
