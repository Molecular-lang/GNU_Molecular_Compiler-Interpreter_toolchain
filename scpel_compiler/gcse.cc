...
static bool should_hoist_expr_to_dom (basic_block, struct gcse_expr *,
				      basic_block,
...
static bool pre_expr_reaches_here_p_work (basic_block, struct gcse_expr *,
					  basic_block, char *);
...
{
  return oprs_unchanged_p (x, insn, false);
}
...
{
  return oprs_unchanged_p (x, insn, true);
}
...
static bool
pre_expr_reaches_here_p (basic_block occr_bb, struct gcse_expr *expr,
			 basic_block bb)
{
  bool rval;
...
{
public:
  pass_rtl_pre (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_pre (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_rtl_hoist (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_hoist (scpel_compiler::context *ctxt)
{
