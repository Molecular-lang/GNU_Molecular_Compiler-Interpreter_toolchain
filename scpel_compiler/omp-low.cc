...
{
public:
  pass_lower_omp (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_omp (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_diagnose_omp_blocks (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_diagnose_omp_blocks (scpel_compiler::context *ctxt)
{
