...
{
public:
  pass_warn_printf (scpel_compiler::context *ctxt)
...
{
public:
  pass_strlen (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_warn_printf (scpel_compiler::context *ctxt)
{
  return new pass_warn_printf (ctxt);
}

gimple_opt_pass *
make_pass_strlen (scpel_compiler::context *ctxt)
{
