...
compare_type_sizes (tree type1, tree type2)
{
  /* Be conservative for arrays and vectors.  We want to support partial
     overlap on int[3] and int[3] as tested in scpel_compiler.dg/torture/alias-2.c.  */
  ...
  if (same_p == 1)
    {
	 ...
	 size as tested in scpel_compiler.dg/torture/alias-2.c.
			       ...
			       alias_set_type base2_alias_set, bool tbaa_p)
{
  ...
  /* If both references are through the same type, they do not alias
     ...
     See scpel_compiler.dg/torture/alias-2.c.  */
  if (((TREE_CODE (base1) != TARGET_MEM_REF
