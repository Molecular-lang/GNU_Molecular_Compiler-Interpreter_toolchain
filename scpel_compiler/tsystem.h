...
/* System headers (e.g. stdio.h, stdlib.h, unistd.h) sometimes
   indirectly include getopt.h.  Our -I flags will cause scpel_compiler's gnu
...
#else /* ! inhibit_libc */
/* We disable this when inhibit_libc, so that scpel_compiler can still be built without
