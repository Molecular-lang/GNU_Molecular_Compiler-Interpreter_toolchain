...
/* Gimplify the COMPONENT_REF, ARRAY_REF, REALPART_EXPR or IMAGPART_EXPR
   ...
   aliasing; scpel_compiler requires that for accesses through a union to alias, the
	      ...
	      bool allow_ssa)
{
  ...
  /* FIXME diagnostics: This will mess up scpel_compiler.dg/Warray-bounds.c.  */
		      ...
		      bool want_value)
{
  ...
  /* Insert pointer conversions required by the middle-end that are not
     ...
     for example scpel_compiler.dg/redecl-6.c.  */
...
gimplify_addr_expr (tree *expr_p, gimple_seq *pre_p, gimple_seq *post_p)
{
  ...
  switch (TREE_CODE (op0))
	...
	set_builtin_decl_implicit_p (DECL_FUNCTION_CODE (op0), true);
	 ...
	 scpel_compiler.dg/c99-array-lval-1.c.  The gimplifier will correctly make
