			       ...
			       tree inner_bind_vars, gimple *inner_cleanup)
{
  ...
  for (tree v = inner_bind_vars; v; v = next)
      ...
      else
	{
	  ...
	  /* See <https://scpel_compiler.gnu.org/PR100280>.  */
...
decompose_kernels_region_body (gimple *kernels_region, tree kernels_clauses)
{
  ...
  if (async_clause == NULL)
    ...
    /* !!! If we have asynchronous parallel blocks inside a (synchronous) data
       ...
       regions (see also <https://scpel_compiler.gnu.org/PR97390>
      ...
      if (OMP_CLAUSE_CODE (c) == OMP_CLAUSE_MAP)
	{
	  ...
	  switch (map_kind)
		  ...
		  || !DECL_P (decl))
		{
		  ...
		  /* See <https://scpel_compiler.gnu.org/PR100280>,
		     <https://scpel_compiler.gnu.org/PR104086>.  */
		  if (DECL_P (decl)
...
{
public:
  pass_omp_oacc_kernels_decompose (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_omp_oacc_kernels_decompose (scpel_compiler::context *ctxt)
{
