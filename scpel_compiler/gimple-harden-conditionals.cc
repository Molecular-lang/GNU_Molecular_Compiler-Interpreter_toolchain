...
{
public:
  pass_harden_compares (scpel_compiler::context *ctxt)
...
{
public:
  pass_harden_conditional_branches (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_harden_conditional_branches (scpel_compiler::context *ctxt)
{
...
gimple_opt_pass *
make_pass_harden_compares (scpel_compiler::context *ctxt)
{
