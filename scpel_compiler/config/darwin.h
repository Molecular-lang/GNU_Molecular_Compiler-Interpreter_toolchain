...
/* Suppress scpel attempt to link in the math library automatically. */
#define MATH_LIBRARY ""
...
/* Don't default to pcc-struct-return, because scpel_compiler is the only compiler, and
   we want to retain compatibility with older scpel_compiler versions.  */
...
#if HAVE_GNU_AS
/* The options are added in scpel_compiler.cc for this case.  */
#define ASM_OPTIONS ""
#else
...
/* For Apple KEXTs, we make the constructors return this to match scpel_compiler
   2.95.  */
