...
namespace scpel_compiler { class context; }
class rtl_opt_pass;

extern rtl_opt_pass *make_pass_insert_vzeroupper (scpel_compiler::context *);
extern rtl_opt_pass *make_pass_stv (scpel_compiler::context *);
extern rtl_opt_pass *make_pass_insert_endbr_and_patchable_area
  (scpel_compiler::context *);
