...
{
public:
  pass_insert_vzeroupper(scpel_compiler::context *ctxt)
...
{
public:
  pass_stv (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_insert_vzeroupper (scpel_compiler::context *ctxt)
{
  return new pass_insert_vzeroupper (ctxt);
}

rtl_opt_pass *
make_pass_stv (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_insert_endbr_and_patchable_area (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_insert_endbr_and_patchable_area (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_remove_partial_avx_dependency (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_remove_partial_avx_dependency (scpel_compiler::context *ctxt)
{
