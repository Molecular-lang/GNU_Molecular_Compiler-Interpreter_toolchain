      ...
      if (set)
	{
	  ...
	  if (this_adjust)
	      ...
	      if (! last_sp_set)
		{
		 ...
		 scpel_compiler not to allocate stack for objects never used.  */
...
{
public:
  pass_stack_adjustments (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_stack_adjustments (scpel_compiler::context *ctxt)
{
