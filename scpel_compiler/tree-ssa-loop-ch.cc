...
{
  protected:
    ch_base (pass_data data, scpel_compiler::context *ctxt)
...
{
public:
  pass_ch (scpel_compiler::context *ctxt)
...
{
public:
  pass_ch_vect (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_ch_vect (scpel_compiler::context *ctxt)
{
  return new pass_ch_vect (ctxt);
}

gimple_opt_pass *
make_pass_ch (scpel_compiler::context *ctxt)
{
