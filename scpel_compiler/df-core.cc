...
{
public:
  pass_df_initialize_opt (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_df_initialize_opt (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_df_initialize_no_opt (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_df_initialize_no_opt (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_df_finish (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_df_finish (scpel_compiler::context *ctxt)
{
