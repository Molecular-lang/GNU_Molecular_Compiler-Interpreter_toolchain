...
{
public:
  pass_vrp (scpel_compiler::context *ctxt, const pass_data &data_)
...
{
public:
  pass_assumptions (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_vrp (scpel_compiler::context *ctxt)
{
  return new pass_vrp (ctxt, pass_data_vrp);
}

gimple_opt_pass *
make_pass_early_vrp (scpel_compiler::context *ctxt)
{
  return new pass_vrp (ctxt, pass_data_early_vrp);
}

gimple_opt_pass *
make_pass_assumptions (scpel_compiler::context *ctx)
{
