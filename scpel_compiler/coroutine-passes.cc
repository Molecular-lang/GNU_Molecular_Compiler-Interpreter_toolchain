...
{
public:
  pass_coroutine_lower_builtins (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_coroutine_lower_builtins (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_coroutine_early_expand_ifns (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_coroutine_early_expand_ifns (scpel_compiler::context *ctxt)
{
