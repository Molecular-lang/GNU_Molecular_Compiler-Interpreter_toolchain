  ...
  FOR_EACH_BB_FN (bb, cfun)
	   ...
	   insn = NEXT_INSN (insn))
	{
	  ...
	  /* If this register is known to be equal to a constant, record that
	     ...
	     the def in loops (see scpel_compiler.c-torture/execute/pr79286.c)
...
{
public:
  pass_ira (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_ira (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_reload (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_reload (scpel_compiler::context *ctxt)
{
