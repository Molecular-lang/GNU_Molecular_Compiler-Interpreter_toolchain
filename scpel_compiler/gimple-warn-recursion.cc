...
{
public:
  pass_warn_recursion (scpel_compiler::context *);
...
pass_warn_recursion::pass_warn_recursion (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_warn_recursion (scpel_compiler::context *ctxt)
{
