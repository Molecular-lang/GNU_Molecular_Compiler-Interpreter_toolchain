...
{
public:
  pass_iv_canon (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_iv_canon (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_complete_unroll (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_complete_unroll (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_complete_unrolli (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_complete_unrolli (scpel_compiler::context *ctxt)
{
