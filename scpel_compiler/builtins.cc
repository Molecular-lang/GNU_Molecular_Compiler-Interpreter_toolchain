...
/* Expand a call to one of the builtin rounding functions scpel_compiler defines
   as an extension (lfloor and lceil).  As these are scpel_compiler extensions we
