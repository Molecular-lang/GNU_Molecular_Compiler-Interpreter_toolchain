...
{
public:
  pass_stdarg (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_stdarg (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_lower_vaarg (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_vaarg (scpel_compiler::context *ctxt)
{
