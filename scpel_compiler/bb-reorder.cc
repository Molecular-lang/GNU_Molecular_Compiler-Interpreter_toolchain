...
{
public:
  pass_reorder_blocks (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_reorder_blocks (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_duplicate_computed_gotos (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_duplicate_computed_gotos (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_partition_blocks (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_partition_blocks (scpel_compiler::context *ctxt)
{
