...
scpel_compiler::dump_manager::dump_manager ():
...
void
scpel_compiler::dump_manager::register_pass (opt_pass *pass)
{
  gcc_assert (pass);
...
bool
scpel_compiler::dump_manager::update_dfi_for_opt_info (dump_file_info *dfi) const
{
  gcc_assert (dfi);
