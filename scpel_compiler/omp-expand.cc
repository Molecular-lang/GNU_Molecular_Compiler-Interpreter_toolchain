...
{
public:
  pass_expand_omp (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_expand_omp (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_expand_omp_ssa (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_expand_omp_ssa (scpel_compiler::context *ctxt)
{
