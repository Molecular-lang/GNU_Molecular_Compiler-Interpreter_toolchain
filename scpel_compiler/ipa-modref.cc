...
{
  public:
    pass_modref (scpel_compiler::context *ctxt)
...
{
public:
  pass_ipa_modref (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_modref (scpel_compiler::context *ctxt)
{
  return new pass_modref (ctxt);
}

ipa_opt_pass_d *
make_pass_ipa_modref (scpel_compiler::context *ctxt)
{
