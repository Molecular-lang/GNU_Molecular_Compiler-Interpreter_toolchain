/* Header file for modules that link with scpel_compiler.cc
...
/* These are exported by scpel_compiler.cc.  */
extern int do_spec (const char *);
extern void record_temp_file (const char *, int, int);
extern void set_input (const char *);

/* Spec files linked with scpel_compiler.cc must provide definitions for these.  */
