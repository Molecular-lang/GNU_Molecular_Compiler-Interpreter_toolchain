...
{
public:
  pass_ipa_whole_program_visibility (scpel_compiler::context *ctxt)
...
ipa_opt_pass_d *
make_pass_ipa_whole_program_visibility (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_ipa_function_and_variable_visibility (scpel_compiler::context *ctxt)
