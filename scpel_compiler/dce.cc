...
{
public:
  pass_ud_rtl_dce (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_ud_rtl_dce (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_fast_rtl_dce (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_fast_rtl_dce (scpel_compiler::context *ctxt)
{
