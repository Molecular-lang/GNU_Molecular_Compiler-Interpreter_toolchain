...
ccp_lattice_meet (ccp_prop_value_t *val1, ccp_prop_value_t *val2)
{
  if (val1->lattice_val == UNDEFINED
	 ...
	 also causes a lot of scpel_compiler.dg/uninit-pred*.c FAILs.  */
...
{
public:
  pass_ccp (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_ccp (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_fold_builtins (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_fold_builtins (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_post_ipa_warn (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_post_ipa_warn (scpel_compiler::context *ctxt)
{
