...
{
public:
  pass_loop2 (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_loop2 (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_rtl_loop_init (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_loop_init (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_rtl_loop_done (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_loop_done (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_rtl_move_loop_invariants (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_move_loop_invariants (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_rtl_unroll_loops (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_unroll_loops (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_rtl_doloop (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_doloop (scpel_compiler::context *ctxt)
{
