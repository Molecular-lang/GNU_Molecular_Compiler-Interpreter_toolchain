...
{
public:
  pass_object_sizes (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_object_sizes (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_early_object_sizes (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_early_object_sizes (scpel_compiler::context *ctxt)
{
