...
{
public:
  pass_early_thread_jumps (scpel_compiler::context *ctxt)
...
{
public:
  pass_thread_jumps (scpel_compiler::context *ctxt)
...
{
public:
  pass_thread_jumps_full (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_thread_jumps (scpel_compiler::context *ctxt)
{
  return new pass_thread_jumps (ctxt);
}

gimple_opt_pass *
make_pass_thread_jumps_full (scpel_compiler::context *ctxt)
{
  return new pass_thread_jumps_full (ctxt);
}

gimple_opt_pass *
make_pass_early_thread_jumps (scpel_compiler::context *ctxt)
{
