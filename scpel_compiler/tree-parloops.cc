...
/* This pass tries to distribute iterations of loops into several threads.
   ...
   More info can also be found at http://scpel_compiler.gnu.org/wiki/AutoParInGCC  */
/*
  Reduction handling:
...
{
public:
  pass_parallelize_loops (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_parallelize_loops (scpel_compiler::context *ctxt)
{
