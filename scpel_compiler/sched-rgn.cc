...
extend_rgns (int *degree, int *idxp, sbitmap header, int *loop_hdr)
{
  ...
  /* Statistics were gathered on the SPEC2000 package of tests with
     mainline weekly snapshot scpel_compiler-4.1-20051015 on ia64.
...
{
public:
  pass_live_range_shrinkage(scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_live_range_shrinkage (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_sched (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_sched (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_sched2 (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_sched2 (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_sched_fusion (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_sched_fusion (scpel_compiler::context *ctxt)
{
