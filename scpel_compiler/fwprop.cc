...
{
public:
  pass_rtl_fwprop (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_fwprop (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_rtl_fwprop_addr (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_fwprop_addr (scpel_compiler::context *ctxt)
{
