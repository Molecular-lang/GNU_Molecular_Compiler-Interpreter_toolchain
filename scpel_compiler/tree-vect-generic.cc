...
{
public:
  pass_lower_vector (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_vector (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_lower_vector_ssa (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_lower_vector_ssa (scpel_compiler::context *ctxt)
{
