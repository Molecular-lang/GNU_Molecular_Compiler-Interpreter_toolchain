...
{
public:
  pass_build_cgraph_edges (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_build_cgraph_edges (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_rebuild_cgraph_edges (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_rebuild_cgraph_edges (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_remove_cgraph_callee_edges (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_remove_cgraph_callee_edges (scpel_compiler::context *ctxt)
{
