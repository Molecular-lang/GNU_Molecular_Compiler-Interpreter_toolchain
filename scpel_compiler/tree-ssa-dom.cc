...
{
public:
  pass_dominator (scpel_compiler::context *ctxt)
...
pass_dominator::execute (function *fun)
{
  ...
  /* We need to know loop structures in order to avoid destroying them
     ...
     scpel_compiler.dg/tree-ssa/pr21417.c can't be threaded if loop preheader is
...
gimple_opt_pass *
make_pass_dominator (scpel_compiler::context *ctxt)
{
