...
{
public:
  pass_rtl_ifcvt (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_rtl_ifcvt (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_if_after_combine (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_if_after_combine (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_if_after_reload (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_if_after_reload (scpel_compiler::context *ctxt)
{
