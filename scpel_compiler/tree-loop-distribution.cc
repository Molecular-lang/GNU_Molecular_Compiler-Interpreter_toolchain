      ...
      EXECUTE_IF_SET_IN_BITMAP (drs2, 0, j, bj)
	{
	  ...
	  if (DDR_ARE_DEPENDENT (ddr) == chrec_dont_know)
		...
		this_dir = -this_dir;
		 ...
		 iteration space, see scpel_compiler.dg/tree-ssa/ldist-16.c and
		 scpel_compiler.dg/tree-ssa/pr94969.c.  */
...
{
public:
  pass_loop_distribution (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_loop_distribution (scpel_compiler::context *ctxt)
{
