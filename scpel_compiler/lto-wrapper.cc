...
/* This program is passed a scpel_compiler, a list of scpel_compiler arguments and a list of
   ...
   $ lto-wrapper scpel_compiler/xgcc -B scpel_compiler a.o b.o -o test -flto
...
/* Execute scpel_compiler. ARGC is the number of arguments. ARGV contains the arguments. */
