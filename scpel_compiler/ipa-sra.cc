...
/* Type internal to function pull_accesses_from_callee.  Unfortunately scpel_compiler 4.8
...
{
public:
  pass_ipa_sra (scpel_compiler::context *ctxt)
...
ipa_opt_pass_d *
make_pass_ipa_sra (scpel_compiler::context *ctxt)
{
