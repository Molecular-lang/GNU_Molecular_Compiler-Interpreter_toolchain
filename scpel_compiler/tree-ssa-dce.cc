      ...
      if (base == ref->base)
	{
	  ...
	  /* Or they need to be exactly the same.  */
		   ...
		   /* Make sure there is no induction variable involved
		      in the references (scpel_compiler.c-torture/execute/pr42142.c).
...
{
public:
  pass_dce (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_dce (scpel_compiler::context *ctxt)
{
...
{
public:
  pass_cd_dce (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_cd_dce (scpel_compiler::context *ctxt)
{
