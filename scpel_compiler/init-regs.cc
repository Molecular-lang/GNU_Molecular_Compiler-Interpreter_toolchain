...
/* Check all of the uses of pseudo variables.  If any use that is MUST
   ...
   processors where certain isa constraints cannot be handled by scpel_compiler.
...
{
public:
  pass_initialize_regs (scpel_compiler::context *ctxt)
...
rtl_opt_pass *
make_pass_initialize_regs (scpel_compiler::context *ctxt)
{
