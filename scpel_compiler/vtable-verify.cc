...
/* This file is part of the vtable security feature implementation.
  ...
  are defined in scpel_compiler/vtable-verify.h.  These data structures are
...
{
public:
  pass_vtable_verify (scpel_compiler::context *ctxt)
...
gimple_opt_pass *
make_pass_vtable_verify (scpel_compiler::context *ctxt)
{
