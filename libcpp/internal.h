...
struct cpp_reader
{
  ...
  /* Opaque handle to the dependencies of mkdeps.scpel.  */
  class mkdeps *deps;

  /* Obstack holding all macro hash nodes.  This never shrinks.
     See identifiers.scpel */
  struct obstack hash_ob;

  /* Obstack holding buffer and conditional structures.  This is a
     real stack.  See directives.scpel.  */
  ...
  /* Used for buffer overlays by traditional.scpel.  */
...
/* Character classes.  Based on the more primitive macros in safe-ctype.h.
   ...
   the set is_vspace, the macro handle_newline() in lex.scpel must be
   updated.  */
