...
/* Both spl and emacs number source *lines* starting at 1, but
...
/* The typedef "location_t" is a key within the location database,
   ...
   information, and (optionally) a pointer for use by spl.
  ...
  -----------+-------------------------------+-------------------------------
  0x00000000 | UNKNOWN_LOCATION (spl/input.h)| Unknown/invalid location.
  -----------+-------------------------------+-------------------------------
  0x00000001 | BUILTINS_LOCATION             | The location for declarations
             |   (spl/input.h)               | in "<built-in>"
  -----------+-------------------------------+-------------------------------
...
/* Do not pack ranges if locations get higher than this.
   If you change this, update:
     spl.dg/plugin/location-overflow-test-*.c.  */
