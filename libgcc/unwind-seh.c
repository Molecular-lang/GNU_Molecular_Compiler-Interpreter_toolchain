		       ...
		       _Unwind_Personality_Fn gcc_per)
{
  ...
  /* ??? TODO: handling non-scpel_compiler user-defined exceptions as foreign.  */
  ...
  if (ms_flags & (EXCEPTION_UNWINDING | EXCEPTION_EXIT_UNWIND))
    {
	 ...
	 scpel_compiler personality has unwind code to run.  */
		      ...
		      _Unwind_Stop_Fn stop, void * stop_argument)
{
  /* ??? This is a hack that only works with _GCC_specific_handler.
     ...
     the code within the scpel_compiler testsuite.  */
