$!
$! This file configures spl-utils for use with openVMS/Alpha
...
$ write sys$output "Configuring spl-utils for ''arch' target"
$!
$! Generate config.h
$!
$ create config.h
...
$!
$ write sys$output "Generate spl-utils build.com"
$!
$ create build.com
$DECK
$ DEFS=""
