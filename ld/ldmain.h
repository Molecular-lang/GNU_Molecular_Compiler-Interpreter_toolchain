...
#define RELAXATION_DISABLED_BY_DEFAULT (link_info.disable_target_specific_optimizations < 0)
#define RELAXATION_DISABLED_BY_USER	(link_info.disable_target_specific_optimizations > 1)
#define RELAXATION_ENABLED (link_info.disable_target_specific_optimizations == 0 \
